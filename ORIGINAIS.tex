...
Ainda na mesma linha, para David Harvey (2014, p.~238), as revoluções, políticas,
...
próprio Marx (apud \versal{HARVEY}, 2014, p.~298) já havia percebido que ``é da natureza do capital mover"-se
...
(\versal{BASTOS}, 2002). Para o filósofo brasileiro Nelson Brissac Peixoto (1996, p.~408), o mapeamento é um modo de percepção não"-ocular que se configura
...
\emph{International Cartographic Association Mapping} mapa é a %Mapping não está no título que encontro em busca na internet
...
adquirem ``intensidade espectral, vazia de sentido''.\footnote{Ver
  ...
  Jean"-François Lyotard''. {\slsc{O Que nos Faz Pensar: Cadernos do Departamento
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Henry Holiday. {\slsc{Ocean"-Chart}} (1876). Ilustração para a\break primeira edição de {\slsc{A caçada do Snark}}, de Lewis Carroll}}}
%\end{minipage}
\end{figure}
...
\begin{quote} %manter esse uso do si?
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Guy Debord. {\slsc{Guide Psychogeographique de Paris:\break Discours Sur Les Passions D’Amour}} (1956)}}}
%\end{minipage}
\end{figure}
...
pensamento filosófico, portanto há muito tempo espaço de referência %incluir artigo depois de tempo para tirar ambiguidade "tempo-espaço"?
...
duas dimensões: o ``plano'', a folha de papel em branco, o desenho sobre %e o desenho, para ficar claro que é a segunda dimensão?
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Jan Dibbets. {\slsc{Perspective correction}} (1968)}}} %No texto corrido aparece corrections, com -s
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Andreas Gursky. {\slsc{Chicago Board of Trade \protect\scalebox{.8}{II}}} (1999)}}}
%\end{minipage}
\end{figure}
...
problema da representação do espaço visual 3D na tela de pintura 2-D
