...
unir quanto afastar as pessoas mais intensamente do que laços %laços geográficos ficou confuso
...
Franco Berardi, a humanidade é ``reduzida a um `twist
...
interior de limites estritamente programados'' (2009, p.~126).
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Fritz Lang. {\slsc{Metropolis}} (1927)}}}
%\end{minipage}
\end{figure}
...
entende perfeitamente.\footnote{Esta é também a condição ``kafkiana''
  ...
  (\scalebox{.8}{BORGES}, 2007, v. \scalebox{.8}{IV}, p.~117). Ver página \scalebox{.8}{XXXX} (o ``comando'' de %que páginas são essas?
...
estética própria para o universo dos computadores.\footnote{Depois
  aperfeiçoada no filme {\slsc{Matrix}} (1999), das irmãs Wachowski.} O
...
absolutamente contemporânea que o ensaísta Jonathan Crary
em seu \emph{24/7: capitalismo tardio e os fins do sono} chamou de
``manutenção calculada de um estado de transição contínuo'' (2016, p.~44).
...
ritmo lento da matéria orgânica, sujeito ao cansaço, aos desejos e ao %sujeitos ou sujeita
...
dobrou nesse mesmo período. Se éramos 3,9 bilhões em 1972, agora somos %bilhões certo?
...
urbanismo uma vez que transforma nossa noção de espaço.\footnote{Sabemos
  ...
  Milton Santos, para quem o tempo é a ``a sucessão dos
  eventos e sua trama'', o espaço é ``o meio, o lugar material da
  possibilidade dos eventos'', e o mundo é ``a soma, que é também
  síntese, de eventos e lugares'' (1997, p.~41).} Para Fredric Jameson, um dos
...
correto distanciamento'' (1987, p.~54).
...
a uma distância mínima, a totalidade das coisas. Heidegger identifica o problema que os pensadores do pós"-modernismo vão
...
como se não houvesse distância?'' (1994, p.~144).
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{O labirinto de Tolman e o gráfico que\break mostra a curva de erros dos ratos}}}
%\end{minipage}
\end{figure}
...
``reaprender a pensar o espaço'' (1994, p.~37).
...
(\versal{BASTOS}, 2002). Para o filósofo brasileiro Nelson Brissac Peixoto, o mapeamento é um modo de percepção não"-ocular que se configura
através da fusão do real e do abstrato, sendo ``a primeira imagem de uma
paisagem que não pode ser apreendida diretamente pelo olho'' (1996, p.~408).
...
Jameson, a desalienação no contexto urbano envolveria
então a ``reconquista prática de um sentido de localização e de
reconstrução de um conjunto articulado que pode ser retido na memória'' (2000, p.~77),
...
Se, na conhecida definição de Althusser, a ideologia
``representa a relação imaginária dos indivíduos com as suas condições
reais de existência'' (1970, p.~77), então a proposta de legibilidade do meio urbano
...
linha de raciocínio, David Harvey reconhece a existência
...
simplistas num `grid' cartesiano'' (2001, p.~221).
...
Guattari, que enxergaram no mapa uma estrutura
...
uma ação política ou como uma meditação (2011, p.~30).
\end{quote}
...
\item[4.] Inspirando"-nos nos relatos de viagem dos grandes exploradores do
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Canaletto. {\slsc{Campo Santi Giovanni e Paolo}} (1735-1738)}}}
%\end{minipage}
\end{figure}
...
com sua particularidade, como sugere Suassuna:
...
refletir sobre o que viu (2005, p.~274).
\end{quote}
...
cidade, a \emph{polis}, o lugar político, a tribuna da vida moderna (\versal{WISNIK}, 2012a, p.~197).
\end{quote}
...
Park no clássico ensaio \emph{The city} que, já em 1925,
...
da natureza, e particularmente da natureza humana (1967, p.~25).
\end{quote}
...
Certeau, é uma questão de perspectiva e de distância:
...
gnóstica. Ser apenas este ponto que vê, eis a ficção do saber (1998, p.~170).
\end{quote}
...
Otília Arantes, ao analisar os escritos de Jürgen
