...
alemão.\footnote{O filme contou também com a contribuição do designer futurista norte"-americano \index{Mead, Syd}Syd Mead, que já havia trabalhado em \emph{Alien, o oitavo passageiro} (1979) e \emph{Tron} (1982).} Tanto nos quadrinhos quanto nos filmes, a arquitetura das
...
está tão distante a ponto de ser completamente inacessível.\footnote{Kafka pode ser considerado, nesse sentido, um precursor das distopias modernas, como \emph{1984} (1948), de \index{Orwell, George}George Orwell.} Kafka não se
