...
corte.\footnote{{\slsc{Festim diabólico}} ({\slsc{Rope}}, 1948), de Alfred
...
seja, pode modificar a paisagem como um todo.\footnote{Jorge Luis Borges
  em {\slsc{Atlas}} (1984), seu livro de viagens escrito com María Kodama,
...
com o famoso \emph{grid} de Nova York.\footnote{Criado a partir do
  {\slsc{Commissioners' Plan}} de 1811.} Já Auster tira proveito do
...
concreto.\footnote{O curta"-metragem experimental {\slsc{Broadway by
...
cidade, a sociedade constrói a si mesma'' (1992, p.269).\footnote{Em
  {\slsc{Arte Moderna}}, Argan associa essa visão à proposta pedagógica da
...
metrópol} (1927), de Walter Ruttmann, descreve a cidade como uma grande
...
baixo.\footnote{Na mitologia grega, Ícaro era filho de Dédalo, o
  ...
  {\slsc{Metamorfoses}}, o poeta latino Ovídio conta que os dois foram
...
descreve Victor Hugo em \emph{Notre"-Dame de Paris} (1831).\footnote{``Depois
  ...
  Ver Hugo, Victor. {\slsc{Notre"-Dame de Paris.}} Paris: Gallimard, 1966
...
``telépolis'', entre outros.\footnote{Ver \scalebox{.8}{RUFÍ}, Joan Vicente \scalebox{.8}{I}. Nuevas
...
igualou, em 2015, o número de habitantes do planeta.\footnote{Ver
  International Telecommunication Union. {\slsc{2015 facts and
    figures.}} Genebra: \scalebox{.8}{ICT} data and statistics division, 2015.} São 7
...
urbana.\footnote{Em 2018, estive em Pyongyang, capital da Coreia do
  ...
  {\slsc{tabula rasa}} deixada pelos bombardeios norte"-americano. A cidade
  ...
  constroem essas cidades. Ver \scalebox{.8}{VIEIRA}, Tuca. Uma maquete de si
...
monumentalidade de Paris e da opulência de Nova York\footnote{Chamada de
  ``encantadora catástrofe'' por Le Corbusier. Ver \scalebox{.8}{LE
