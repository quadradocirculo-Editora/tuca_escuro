...
\index{Lang, Fritz}Fritz Lang. Os replicantes são simulacros de humanos, mas têm
...
Joi também surge como propaganda, na escala da cidade. Ela se anuncia
...
está interessado em \emph{decifrar} as imagens, como queria \index{Flusser, Vilém}Vilém
...
replicantes de \index{Scott, Ridley}Ridley Scott, se rebelar a qualquer momento. O simulacro proposto por \index{Baudrillard, Jean}Baudrillard dá mais uma volta do parafuso, rompendo o
último fio de conexão que ainda separava a representação de
...
inclusive, algo \emph{melhor} do que realidade.
