...
``resolução'' digital, mais detalhes são registrados.\footnote{No filme
  {\slsc{Blow"-up}} (1967), de Michelangelo Antonioni, o protagonista é um
...
considerado uma forma central da mediação entre os espaços, %considerado se refere ao conceito; consiredados, aos mapas
