...
telas de alta definição, se torna tão sofisticada, ``hiperreal'', que \label{hiperreal}
...
película, geralmente um negativo.\footnote{Os concursos de fotografia
  ...
  Hoje, mesmo que haja um arquivo ``original'' (chamado {\slsc{\versal{RAW}}}, ou
...
fotografia digitalizada passa a ser um monstruoso quebra"-cabeças
...
isoladamente em cada uma delas.\footnote{Uma câmera de 30
  ...
  milhão de {\slsc{pixels}}). Cada um desses {\slsc{pixels}} tem a sua
...
meia''. Este ``hiperrealismo'' foi definido por \index{Baudrillard, Jean}Baudrillard como uma
simulação de um real que nunca existiu, e que acaba substituindo e
anulando a própria realidade com seu poder de sedução.\footnote{Hiperrealismo
  é também um movimento artístico que tem origem no anos 1960,
  tributário da {\slsc{Pop Art}} e do Fotorrealismo. Enquanto esse último
  criava grandes pinturas a partir de fotografias reproduzidas
  minuciosamente na tela, o Hiperrealismo se manifesta sobretudo na
...
Mas todo esse hiperrealismo não significa necessariamente acesso a um
...
do hiperrealismo, como se dissesse que o olhar nu e cru não basta, que a
...
fotográfica é capaz de enxergá"-la, será preciso criá"-la. Assim,
...
hiperrealismo digital, uma tentativa de representar o irrepresentável
