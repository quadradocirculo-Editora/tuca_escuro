...
deserto borgiano.\footnote{Refiro"-me aqui à parábola ``Os dois reis e os
  ...
  galerías que recorrer, ni muros que veden el paso'' (\scalebox{.8}{BORGES}, 2007a, p.~731). Ou ver p. \pageref{borges}.}
...
partir dos anos 1980.\footnote{Ver \scalebox{.8}{OBRIST}, Hans Ulrich
  ...
  (ed.). {\slsc{The map as art: contemporary artists explore
    cartography}}. New York: Princeton Architectural Press, 2009.} Se o mapa
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{León Ferrari. {\slsc{Cidade}} (1980)}}}
%\end{minipage}
\end{figure}
...
(\versal{BORGES}, 2007a, p.~731).\footnote{O texto foi publicado pela primeira
  ...
  o autor ainda explicava que ``los copistas intercalaron en {\slsc{Las mil e %arrumar para o espanhol, -y em vez de -e e -una em vez de -uma?
...
tempo}, de Joe Gould.\footnote{Uma das grandes peças jornalísticas do
  ...
  autor. Ver \scalebox{.8}{MITCHELL}, Joseph. {\slsc{O segredo de Joe Gould}}. São
