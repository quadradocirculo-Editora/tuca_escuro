...
empresas deveríamos ter, no mínimo, o direito de saber que dados esses, onde estão armazenados, como são utilizados e quem tem acesso a eles.\footnote{Um problema claramente previsto por \index{Lyotard, Jean-François}Lyotard no final dos anos 1970. Ver \scalebox{.8}{LYOTARD}, Jean-François. {\slsc{O pós"-moderno}}. Rio de Janeiro: José Olympio, 1988, p.~119.} Deveríamos conhecer melhor a estrutura física da rede, composta de computadores, linhas telefônicas, \emph{data centers}, satélites e cabos submarinos. A internet, na verdade, é apenas a face amigável de um sistema complexo e
...
\begin{quote}
Ele nos trouxe um grande mapa representando o \qb{}mar,\\
Sem o menor vestígio de terra:\\
E a tripulação ficou muito contente quando \qb{}perceberam\\
...
Assim gritava o capitão Bellman: e a tripulação \qb{}respondia,\\
...
(Gritava a tripulação) ``pois ele nos trouxe o \qb{}melhor ---\\
...
\chapter[{\italic{Atlante}}, de Luigi Ghirri]{{\bold{Atlante}}, de\vspace{-.15cm}\break Luigi Ghirri} % (1973)
...
criativo da prática de mapeamento. Nesse \linebreak
...
\noindent{}contexto, o grupo situacionista
...
\chapter[{\italic{Costruzione legittima}}]{{\bold{Costruzione\vspace{-.15cm}\break legittima}}}
...
reparar, graças ao congelamento fotográfico, numa série de movimentos  \linebreak
...
perspectiva linear. O sistema renascentista \linebreak
...
\noindent{}representa uma primeira
...
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{./imgs/image037.jpg}
...
\part*{\Formular{Práticas artísticas\break de mapeamento}}
...
Há ainda outra prática de mapeamento, talvez a mais elementar de todas.~Trata"-se dos artistas que se utilizam do levantamento \linebreak
...
\chapter[{\italic{Elefante}}, de Gus Van Sant]{{\bold{Elefante}}, de\vspace{-.15cm}\break Gus Van Sant} %(2003)
...
\chapter[{\italic{Spin out}}, de Richard Serra]{{\bold{Spin out}}, de\vspace{-.15cm}\break Richard Serra} % (1973)
...
\chapter[{\italic{Cidade/city/cité}}, de Augusto de Campos]{{\bold{Cidade/city/cité}}, de\vspace{-.15cm}\break Augusto de Campos} % (1963)
...
\chapter[{\italic{As cidades invisíveis}}, de Italo Calvino]{{\bold{As cidades invisíveis}},\vspace{-.15cm}\break de Italo Calvino} % (1972)
...
\chapter[{\italic{Atlas\,\,fotográfico\,\,da\,\,cidade\,\,de\break São Paulo e seus arredores}} \bigskip]{{\bold{Atlas fotográfico da}}\vspace{-.15cm}\break {\bold{cidade de São Paulo}}\vspace{-.15cm}\break {\bold{e seus arredores}}}
...
\begin{figure}[H]
\vspace*{-.5cm}
\hspace*{-.1cm}\includegraphics[width=96mm]{./imgs/atlas1b.jpg}
\end{figure}
...
\begin{figure}[H]
\vspace*{-.5cm}
\hspace*{-1.5cm}\includegraphics[width=95.2mm]{./imgs/atlas2c.jpg}
\end{figure}
\end{absolutelynopagebreak}
