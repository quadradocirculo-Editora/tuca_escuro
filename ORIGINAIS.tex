...
do mundo virtual como palco de grandes embates culturais.\footnote{Utilizo aqui o termo ``virtual'' em seu sentido amplo, que diz respeito genericamente ao mundo das comunicações intermediadas pelos computadores, pelo ambiente de tecnologia digital ligado à rede. No sentido original, virtual significa algo que existe como potência e possibilidade, uma capacidade de ``vir a ser''. Nesse sentido, o virtual se opõe ao atual, e não ao real.} No livro, o
...
humanas se tornam interpretações de cálculos automáticos.\footnote{Ver ``The Secret Rules of Modern Living Algorithms'', documentário da \scalebox{.8}{BBC} produzido por Marcus Du Sautoy.} Os
...
deserto borgiano.\footnote{Ver página \pageref{borges}.} %Padronizar ver página
...
quanto as necessidades de quem o financiou.\footnote{Diferentemente de
  ...
  Ribeiro, \index{Mercator, Gerardo}Gerardo Mercator, \index{Blaeu, Joan}Joan Blaeu e \index{Cassini (família), XX}família Cassini estão entre os
...
My path leads to the creation of a fresh perception of the world. I decipher in a new way a world unknown to you''. Ver \scalebox{.8}{MICHELSON}, Annette (ed.). {\slsc{Kino-Eye: The Writings of Dziga Vertov}}. Berkeley: University of California Press, 1984, p.~17 (trad.~minha). Publicado originalmente em 1923 na revista de vanguarda {\slsc{\scalebox{.8}{LEF}}} ({\slsc{Frente de esquerda das artes}}), fundada por Osip Brik e Vladimir Maiakovski.} No
...
real''. Trata"-se de outra forma de falsificação da realidade, não mais a deficiência de uma ``meia verdade'', mas o excesso de ``uma verdade e meia''. Este \emph{hiperrealismo} é um modo de ver que se alinha às
...
conhecimento.\footnote{ver página XX (por enquanto p.~69).} %%% linkar
...
pós"-modernidade'' por Fredric \index{Jameson, Fredric}Jameson ---, não seria seu trabalho uma legítima
...
\chapter{\emph{Elefante} (2003), de Gus Van Sant} %numeração da pagina está diferente
