...
deserto borgiano.\footnote{Refiro"-me aqui à parábola ``Os dois reis e os
  dois labirintos'', de \index{Borges, Jorge Luis}Jorge Luis Borges. Para castigar o rei da
...
dobrou nesse mesmo período. Se éramos 3,9 milhões em 1972, agora somos %bilhões certo?
...
quando \index{Benjamin, Walter}Walter Benjamin escreve o célebre ensaio \emph{A obra de arte na
...
pelo filósofo francês \index{Rancière, Jacques}Jacques Rancière (2009, p.~115, trad. nossa):
...
\index{Deleuze, Gilles}Deleuze e Guattari ao \emph{não"-lugar} de \index{Augé, Marc}Marc Augé; do \emph{terrain
vague} de \index{Solà-Morales, Ignasi de}Solà"-Morales ao \emph{hiperespaço} de Fredric \index{Jameson, Fredric}Jameson, esse
...
\index{Harvey, David}David Harvey (2001, p.~220, trad. nossa), segundo a qual ``a cartografia
...
O sociólogo e filósofo francês \index{Baudrillard, Jean}Jean Baudrillard enxergou nessa situação
...
São o que o \index{Baudrillard, Jean}Baudrillard chama de \emph{simulacros}, imitações que nada
...
professor \index{Fabbrini, Ricardo}Ricardo Fabbrini chama de ``déficit ontológico'' ---, não resta
...
vinculada ao erotismo e à sedução, ao sagrado e ao segredo''.\footnote{Ver
  \index{Fabbrini, Ricardo}\scalebox{.8}{FABBRINI}, Ricardo Nascimento. ``O que está acontecendo com as
  imagens?: arte, mídia e educação em \index{Baudrillard, Jean}Jean
...
atemporal Paris"-Marselha} (1983), de \index{Cortázar, Julio}Julio Cortázar e \index{Dunlop, Carol}Carol Dunlop. O
...
pesquisadora \index{Steyerl, Hito}Hito Steyerl (2012, p.~19, trad. nossa), ``ao mesmo tempo
...
\index{Velázquez, Diego}Velázquez. 
...
metáfora da verdade e da razão. Enquanto isso, \index{Corbusier, Le}Le Corbusier introduz o
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{\index{Dibbets, Jan}Jan Dibbets. {\slsc{Perspective correction}} (1968)}}} %No texto corrido aparece corrections, com -s
%\end{minipage}
\end{figure}
...
(1932), de \index{Cartier-Bresson, Henri}Henri Cartier"-Bresson ou \emph{Guerrilheiro Heroico} (o
retrato de Che Guevara, de 1960), de \index{Korda, Alberto}Alberto Korda, por exemplo. Basta
...
da missão lunar \index{Apolo 17}Apolo 17, em 1972. A fotografia é creditada à tripulação
...
se tornar imagem novamente, na tela do computador.\footnote{Evito, na
  ...
  pouco como chamar de ``cinema analógico'' aquilo que \index{Hitchcock, Alfred}Hitchcock,
  \index{Antonioni, Michelangelo}Antonioni e \index{Kubrick, Stanley}Kubrick fizeram. A propósito, os termos em francês me
...
parecido com o de \index{Canaletto}Canaletto). O trabalho fotográfico de campo é apenas a
...
aprimorado em outros trabalhos), \index{Gursky, Andreas}Gursky elimina aquele ponto único no
...
em geral. Nessa obra, \index{Gursky, Andreas}Gursky desmonta a perspectiva linear e constrói um
...
residencial. Se os \index{Becher, Bernd e Hilla}Bechers criaram suas ``tipologias'', fotografando
diversas variantes de um mesmo tipo de edificação, e depois reunindo"-as
em ``grids'' expositivos, \index{Gursky, Andreas}Gursky parece fazer o mesmo numa única
fotografia. Assim como no trabalho do casal alemão, esta obra de \index{Gursky, Andreas}Gursky
...
\index{Gursky, Andreas}Andreas Gursky faz parte da chamada ``escola de fotografia de
Düsseldorf'', uma tendência da fotografia contemporânea formada a partir
da influência do casal \index{Becher, Bernd e Hilla}Bernd e Hilla Becher. Ele, \index{Struth, Thomas}Thomas Struth e \index{Ruff, Thomas}Thomas
...
fotografia para o campo da arte contemporânea.\footnote{Opto por me \label{ferramenta}
  referir a \index{Gursky, Andreas}Andreas Gursky mais como fotógrafo do que como artista,
  ...
  inócua. Seria como dizer que \index{Picasso, Pablo}Picasso não é um pintor, mas um ``artista
  que se utiliza da tinta como ferramentas de trabalho''. Numa conversa
  entre os fotógrafos \index{Shore, Stephen}Stephen Shore e \index{Soth, Alec}Alec Soth, este último compara a
  expressão ``artistas usando a fotografia'' com ``fotógrafos usando a
  arte'', concluindo que os discípulos do casal \index{Becher, Bernd e Hilla}Becher estariam mais
  próximos dessa segunda categoria. Ver \scalebox{.8}{SOTH}, Alec. ``A conversation with
  \index{Shore, Stephen}Stephen Shore''. {\slsc{Financial Times}}. Londres. 10 maio 2019.} Com
...
fotográfica. Aqui, segundo a crítica \index{Cotton, Charllotte}Charllotte Cotton (2010, p.~81),
...
\index{Gursky, Andreas}Gursky, na esteira dos outros fotógrafos da ``escola de Düsseldorf'',
...
``resolução'' digital, mais detalhes são registrados.\footnote{No filme
  ...
  cena semelhante, talvez em homenagem ao filme de \index{Antonioni, Michelangelo}Antonioni. O detetive
...
mundo real está submetido. Este é o encanto de uma fotografia de \index{Shore, Stephen}Stephen
...
comunicações em rede. Nesse sentido, \index{Gursky, Andreas}Gursky provavelmente preferiria a
...
\index{Wisnik, Guilherme}Guilherme Wisnik, uma estranha relação entre nitidez e opacidade --- duas
...
\index{Gursky, Andreas}Gursky, no entanto, parece dizer a todo tempo que o olhar nu e cru não
...
apreensão visual ocular. A realidade, na proposta de \index{Gursky, Andreas}Gursky, estaria
...
preciso crer para ver'' pois, aceitando as imagens de \index{Gursky, Andreas}Gursky, o mundo
...
alemã podemos também pensar o trabalho de \index{Gursky, Andreas}Gursky a partir da categoria
...
fragilidade humana.\footnote{Na última estrofe do Canto \scalebox{.8}{I} do poema épico
  {\slsc{Os Lusíadas}} (1572), o poeta português \index{Camões, Luís de}Luís de Camões oferece
...
conforme percebidos por \index{Jameson, Fredric}Jameson, \index{Virilio, Paul}Virilio e \index{Bauman, Zygmunt}Bauman.
...
pós"-modernidade'',\footnote{Ver \index{Fabbrini, Ricardo}\scalebox{.8}{FABBRINI}, Ricardo Nascimento. ``Estética e
  crítica da arte em \index{Lyotard, Jean-François}Jean"-François Lyotard''. {\slsc{O Que nos Faz
...
A obra de Andreas \index{Gursky, Andreas}Gursky flerta com esse sublime tanto nos temas
...
imensidão das paisagens naturais, como nas pinturas de \index{Wolf, Caspar}Caspar Wolf (1735-1783) e de \index{Friedrich, Caspar David}Caspar David Friedrich (1774-1840).
...
disruptiva), a estética de \index{Gursky, Andreas}Gursky é domesticada por um ``sublime
...
Nesse sentido não seriam as imagens de \index{Gursky, Andreas}Andreas Gursky uma tentativa de
...
pós"-modernidade'' por Fredric \index{Jameson, Fredric}Jameson ---, não seria seu trabalho uma
...
estético proposto por \index{Jameson, Fredric}Jameson?
...
obra, sobretudo às abordagens de cunho marxista.\footnote{\index{Gursky, Andreas}Gursky ganhou
...
balão por \index{Nadar, Félix}Nadar, no século \versal{XIX}, até as imagens aéreas de supostos
...
O escultor \index{Serra, Richard}Richard Serra se utiliza desse tipo de marcação do território
...
era arte na época de \index{Platão}Platão passou a ser outra coisa para os alemães do
...
Navegações, mas também podemos ler \emph{Os Lusíadas} (1572), de \index{Camões, Luís de}Camões;
podemos tentar descrever a morte, mas também podemos simplesmente
escutar o \emph{Réquiem} (1791), de \index{Mozart, Wolfgang Amadeus}Mozart.
...
quer o cineasta \index{Wenders, Wim}Wim Wenders (2001, p.~7), tem a capacidade de fazer dois
...
objetividade no trabalho dos \index{Becher, Bernd e Hilla}Bechers.\footnote{Compartilho da opinião de
  \index{Didi-Huberman, Georges}Didi"-Huberman (2004, p.~59, trad. nossa) sobre a objetividade fotográfica: ``em geral pede"-se
...
Essa revalorização das estruturas industrias deve muito a \index{Corbusier, Le}Le Corbusier
...
seus próprios pontos de vista.\footnote{Como no conto {\slsc{A
  construção}}, de \index{Kafka, Franz}Kafka. Ver p.~\pageref{construcao}.} Para isso, faz uso
...
\index{Serra, Richard}Serra (1994, p.~16, trad. nossa) diz que as placas foram distribuídas
...
terreno''. \index{Serra, Richard}Serra propõe, portanto, uma conscientização espacial que anda
de mãos dadas com a experiência crítica, bem diferente de uma simples
contemplação passiva. \index{Serra, Richard}Serra chama esse processo de ``pensar com os pés''
(``thinking on your feet'').

Podemos estender essa proposta de \index{Serra, Richard}Serra para bem além do mundo
...
(1995) de \index{Jeanne-Claude, Christo e}Christo e Jeanne"-Claude, é um cartão"-postal que pede para ser
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{\index{Jeanne-Claude, Christo e}Christo e Jeanne"-Claude. {\slsc{Reichstag embrulhado}} (1995)}}}
%\end{minipage}
\end{figure}
...
cujo referente não existe mais.\footnote{Para \index{Wisnik, Guilherme}Guilerme Wisnik, a
...
\versal{XX}.\footnote{A obra de \index{Long, Richard}Long seria, para a escultura, o que o
  {\slsc{Quadrado negro}} (1915), de \index{Malevich, Kazimir}Malevich, é para a pintura: um
...
Akerman, além de celebrado pelo arquiteto \index{Koolhaas, Rem}Rem Koolhaas em seu
...
\emph{Viagens de \index{Polo, Marco}Marco Polo}, escritas no século \versal{XIII} por \index{Rustichello da Pisa}Rustichello da %de Pisa, como é o padrão do português para gentílicos?
...
nesse cenário. \index{Argan, Giulio Carlo}Giulio Argan (1992, p.~269), nesse sentido, nos traz uma definição
...
descreve \index{Hugo, Victor}Victor Hugo em \emph{Notre"-Dame de Paris} (1831).\footnote{``Depois
  ...
  (trad. nossa).} Já \index{Certeau, Michel de}Michel de Certeau precisou subir ainda mais e foi
...
a cidade. Além disso, a qualquer momento \index{Certeau, Michel de}Certeau podia tomar o elevador
...
pela queda do muro). \index{Wenders, Wim}Wenders (2005, p.~125, trad. nossa) enxergava
...
\index{Solà-Morales, Ignasi de}\index{Solà-Morales, Ignasi de}Ignasi de Solà"-Morales (2002, p.~126, trad. nossa) para descrever esses
...
contemporaneidade. \index{Argan, Giulio Carlo}Giulio Carlo Argan (1992, p.~235) apontou, no início
...
\index{Arantes, Otília}Otília Arantes, ao analisar os escritos de \index{Habermas, Jürgen}Jürgen
...
palavras do influente arquiteto holandês \index{Koolhaas, Rem}Rem Koolhaas (2011, p.~72).
...
(pós"-moderna) de \index{Virilio, Paul}Virilio, \index{Corboz, André}Corboz, \index{Koolhaas, Rem}Koolhaas, \index{Wenders, Wim}Wenders, Brissac e \index{Habermas, Jürgen}Habermas
...
entre si e com o ambiente (\index{Argan, Giulio Carlo}\versal{ARGAN}, 1992, p.~265).
\end{quote}
...
existo'' de \index{Descartes, René}Descartes dá lugar ao ``fotografo, logo existo''.
...
pode ser tornar um instrumento de deseducação do olhar,\footnote{Em
  ...
  nossa.} como percebe o mesmo \index{Calvino, Italo}Italo Calvino (1992, p.~54):
...
processos socais. \index{Lynch, Kevin}Kevin Lynch também usou a cidade como laboratório de
...
urbana.\footnote{Em 2018, estive em Pyongyang, capital da Coreia do
  ...
  por \index{Corbusier, Le}Le Corbusier na Carta de Atenas. E uma vez que a cidade pôde ser
...
monumentalidade de Paris e da opulência de Nova York,\footnote{Chamada de
  ``encantadora catástrofe'' por \index{Corbusier, Le}Le Corbusier. Ver \scalebox{.8}{LE
...
plenamente de acordo com o pensamento de \index{Argan, Giulio Carlo}Argan (1992, p.~63), que
...
ilhado no centro de um território sem limites. Diferentemente de \index{Certeau, Michel de}Certeau
e do personagem de \index{Angeli}Angeli, que subiram no alto do prédio em busca de ver
