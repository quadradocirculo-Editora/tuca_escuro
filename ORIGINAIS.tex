...
\hfill{}\versal{O CANTOR}: Não.
}
\end{vplace}


\vfill\hfill{\footnotesize
Bertolt Brecht, \emph{O círculo de giz caucasiano}
}
...
%\movetooddpage
%\begin{figure}
%\addcontentsline{toc}{part}{\footnotesize\MakeUppercase{\textbf{NOVOS ESPAÇOS}}}
\part[\footnotesize\MakeUppercase{\textbf{NOVOS ESPAÇOS}}]{\Formular{Novos espaços}}
%\vspace*{-1cm}
%\hspace*{-1.5cm}\includegraphics*[width=130mm]{./imgs/cap1.pdf}
%\end{figure}


\chapter[Los Angeles, 2019]{Los Angeles,\vspace{-.15cm}\break 2019}
\hedramarkboth{LOS ANGELES, 2019}{}
...
quadrinhos de ficção científica \emph{Metal Hurlant},\footnote{Publicada nos Estados Unidos como
  {\slsc{Heavy Metal}.}} sobretudo nos
desenhos de \index{Moebius}Moebius que, por sua vez, guardam evidente parentesco com
o filme \emph{Metropolis} (1927), de \index{Lang, Fritz}Fritz Lang, ícone do expressionismo
alemão.\footnote{O filme contou também com a contribuição do designer futurista norte"-americano \index{Mead, Syd}Syd Mead, que já havia trabalhado em {\slsc{Alien, o oitavo passageiro}} (1979) e {\slsc{Tron}} (1982).} Tanto nos quadrinhos quanto nos filmes, a arquitetura das
...
\begin{figure}[!ht]
 \includegraphics[width=\textwidth]{./imgs/image001.jpg}
...
O aumento das desigualdades sociais, a emergência da crise climática, a disseminação da insegurança, a importância econômica e cultural do Oriente, a submissão dos governos ao controle corporativo, a incerteza de futuro e o individualismo desenfreado, são aspectos do mundo de hoje que o filme de 1982 já anunciava. Mesmo o surgimento de empresários imbuídos da tarefa de transformar o mundo através da tecnologia --- como demiurgos (pensemos em \index{Bezos, Jeff}Jeff Bezos e \index{Musk, Elon}Elon Musk) --- já estava presente.

O grande acerto do filme --- e do \emph{cyberpunk} de uma forma geral --- diz respeito justamente à organização do sistema de poder. Diferentemente do célebre romance \emph{1984} (1948), de \index{Orwell, George}George Orwell, que apostava na ideia de um governo totalitário e paranoico, nas cidades do \emph{cyberpunk} o poder é exercido por difusas e gigantescas corporações privadas. A tecnocracia pós"-nacional e desregulada de nosso mundo hipercapitalista, baseada no domínio da técnica, da ciência e da informação, é uma realidade. O poder, concentrado na mão de algumas empresas, em associação a um Estado submisso, impede a participação efetiva dos cidadãos. 
...
\begin{figure}[t]
 \includegraphics[width=\textwidth]{./imgs/image002.jpg}
...
não mapeável do próprio capitalismo tardio''. Já o filósofo francês \index{Levy, Pierre@Lévy, Pierre}Pierre
...
hábitos, rotinas e trajetos, às vezes melhor do que nós mesmos. Como verdadeiros ``Mini Brothers'' (o termo é da professora \index{Beiguelman, Giselle}Giselle Beiguelman), nossos celulares rastreiam nossos passos, sabendo onde e com quem estivemos. Com isso, essas empresas são
...
empresas deveríamos ter, no mínimo, o direito de saber que dados são esses, onde estão armazenados, como são utilizados e quem tem acesso a eles.\footnote{Um problema claramente previsto por \index{Lyotard, Jean-François}Lyotard no final dos anos 1970. Ver \scalebox{.8}{LYOTARD}, Jean-François. {\slsc{O pós"-moderno}}. Rio de Janeiro: José Olympio, 1988, p.~119.} Deveríamos conhecer melhor a estrutura física da rede, composta de computadores, linhas telefônicas, \emph{data centers}, satélites e cabos submarinos. A internet, na verdade, é apenas a face amigável de um sistema complexo e
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image003.jpg}
...
\index{Berardi, Franco}Franco Berardi (2009, p.~126), a humanidade é ``reduzida a um `\emph{twist finger}', a um dedo que se agita, a um corpo paralisado e a uma bomba de
informação supersaturada que navega em canais e realiza escolhas no
interior de limites estritamente programados''.

\chapter[A chegada do futuro]{A chegada\vspace{-.15cm}\break do futuro}
\hedramarkboth{A CHEGADA DO FUTURO}{}

Se observarmos bem, veremos que o \emph{cyberpunk} dos anos 1980 é um ponto fora da curva de otimismo tecnológico que percorreu o século \versal{XX}. Podemos perceber uma recorrência do binômio entusiasmo/decepção em alguns momentos marcantes. Nos anos 1920, época do futurismo e de sua apologia à máquina, do célebre texto de \index{Benjamin, Walter}Benjamin,\footnote{Ver página \pageref{benjamin}.} dos filmes de \index{Vertov, Dziga}Dziga Vertov\footnote{Ver página \pageref{vertov}.} e do teatro de \index{Brecht, Bertolt}Brecht,\footnote{Ver página \pageref{brecht}.} a fotografia, o rádio e o cinema alimentaram uma crença na democratização da comunicação, mas tiveram que lidar com a realidade da tecnologia de guerra. Os anos 1960, época da difusão do vídeo e da televisão, e da ``aldeia global'' de \index{McLuhan, Marshall}McLuhan,\footnote{Ver página \pageref{mcluhan}.} precederam a desregulamentação dos mercados e a financeirização da economia, com todas suas injustiças sociais. Nos anos 1990, foi a vez dos computadores pessoais, da internet e da ``globalização'', que afinal resultou no uso da tecnologia como ferramenta de controle e vigilância. 
...
nos explica \index{Berardi, Franco}Berardi (2019, p.~93). Nas civilizações tradicionais, diz ele, a visão do futuro pode ser maldita, destino trágico dos visionários
...
século \versal{XX} como também a criação de novas histórias do gênero, adaptadas à realidade do século \versal{XXI}. Desde a paranoia nuclear dos anos 1970, não se viam tantas
...
do século \versal{XIX}, tem um marco visual importante justamente com
...
entende perfeitamente.\footnote{Esta é também a condição ``kafkiana''
  ...
  todas suas ficções há hierarquias e essas hierarquias são infinitas''
  (\scalebox{.8}{BORGES}, 2007, v. \scalebox{.8}{IV}, p.~117). Ver página \pageref{comando}.} Acerta também na antecipação daquilo que vem sendo chamado de
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image004.jpg}
...
desregulamentação da economia e o advento da internet.\footnote{Popularizada
  ...
  ``futuro disfuncional'' da internet. Ver ``\index{Berners-Lee, Tim}Sir Tim Berners"-Lee spoke to
  the \scalebox{.8}{BBC}'s Rory Cellan"-Jones''. \scalebox{.8}{BBC}, 2019.} Mas há, segundo ele, uma relação íntima e
...
É neste contexto de abertura neoliberal que,
...
geração \emph{beatnik} da costa oeste americana nos anos 1960.
...
O fato é que deveríamos ter levado \index{Gibson, William}William Gibson a sério. Havia uma dimensão crítica em sua obra para além da aparente superficialidade de uma literatura marginal. O \emph{cyberpunk} deve ser entendido como utopia negativa,\footnote{A utopia \label{utopianegativa}
negativa, ou distopia, não deve ser entendida como o \emph{contrário} de uma utopia. As duas descrições são projeções de futuro, diferentes apenas no tipo de futuro imaginado.} que retrata o mundo que não queremos, produzindo aquilo que \index{Horkheimer, Max}Max Horkheimer (1975, p.~147) chamou de ``uma imagem do futuro, surgida da compreensão profunda do presente''. Ao exagerar aspectos do presente que podem ser indesejáveis no futuro, obras desse gênero demonstram ``consciência histórica'' e funcionam como um alerta, uma forma de resistência, um chamado para a ação enquanto é tempo. Podemos entender dessa forma as palavras de \index{Adorno, Theodor}Theodor Adorno (2001, p.~92) acerca do romance \emph{Admirável mundo novo} (1932), de \index{Huxley, Aldous}Aldous Huxley, uma obra que, fundada na ideia do medo, ``procura apreender o choque a partir do princípio de desencantamento do mundo, elevar esse princípio ao extremo do absurdo e derivar da compreensão da desumanidade a ideia de dignidade humana''.

A distopia dos anos 2010, produto direto do fracasso, nos anos 2000, da utopia cibercultural surgida nos anos 1990, foi percebida e antecipada nos anos 1980 por autores como \index{Gibson, William}Gibson. O \emph{cyberpunk} já tinha percebido que não há acordo
...
\chapter[Grades brilhantes de lógica]{Grades\vspace{-.15cm}\break brilhantes\vspace{-.15cm}\break de lógica}
\hedramarkboth{GRADES BRILHANTES DE LÓGICA}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image005.jpg}
...
futuristas deslizam em altíssima velocidade, lembrando a \emph{Matrix} do livro de \index{Gibson, William}Gibson (2016, p.~25), com suas ``grades brilhantes de lógica se desdobrando sobre aquele vácuo sem cor''. 
...
\chapter[Um salto no escuro]{Um salto\vspace{-.15cm}\break no escuro}
\hedramarkboth{UM SALTO NO ESCURO}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image006.jpg}
\caption{\tiny{\Formular{Michael Wolf. {\slsc{Architecture of density \#116}}, Hong Kong (2009)}}}
\end{figure}

Pensadores como Fredric \index{Jameson, Fredric}Jameson, \index{Virilio, Paul}Paul Virilio, \index{Harvey, David}David Harvey e \index{Bauman, Zygmunt}Zygmunt Bauman
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image007.jpg}
...
análise, \index{Jameson, Fredric}Jameson mostra como o hotel aspira ser um ``espaço total'',
...
ardiloso, cheio de estratégias para que o sujeito não ache a saída. É um lugar asséptico, ``purificado'', livre dos indivíduos ``indesejados'', que nos fazem lembrar de nossa responsabilidade social. Na expressão kafkiana de \index{Bauman, Zygmunt}Bauman, é um lugar onde ``não é necessário fazer mais perguntas --- que, de qualquer forma, não seriam respondidas''.

\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image008.jpg}
...
as definições de \emph{espaço liso} colocadas por \index{Deleuze, Gilles}Deleuze e \index{Guattari, Félix}Guattari. A
...
próprios pensadores do pós"-modernismo: 

\begin{quote}
Em sociedades mais antigas, e
...
Paul \index{Virilio, Paul}Virilio (1993, p.~76) aponta na mesma direção.
...
lugar.\footnote{``Aldeia global'' é o famoso termo cunhado nos anos 1960
  pelo filósofo canadense \index{McLuhan, Marshall}Marshall \label{mcluhan}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image009.jpg}
\caption{\tiny{\Formular{Trens de alta velocidade, Wuhan, China (2012)}}}
\end{figure}
...
\chapter[O rato no labirinto]{O rato no\vspace{-.15cm}\break labirinto}
\hedramarkboth{O RATO NO LABIRINTO}{}

Se a indagação quintessencial da modernidade, resumida por \index{Gauguin, Paul}Paul Gauguin, era
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image007.jpg}
\caption{\tiny{\Formular{\index{Tolman, Edward}O labirinto de Tolman}}}
\end{figure}
...
\index{Deleuze, Gilles}Deleuze e \index{Guattari, Félix}Guattari ao ``não lugar'' de \index{Augé, Marc}Marc Augé; do \emph{terrain
...
partir do conceito de ``mapeamento cognitivo''.\footnote{\index{Jameson, Fredric}Jameson utiliza
  pela primeira vez o termo no ensaio {\slsc{Postmodernism, or, the
    Cultural Logic of Late Capitalism}}, publicado originalmente em 1984 na
  revista {\slsc{New Left}}. O ensaio foi posteriormente publicado como o
  primeiro capítulo do livro de mesmo nome, em 1991.} O termo
propriamente dito provém do universo da neurociência, e foi
primeiramente usado pelo psicólogo \index{Tolman, Edward}Edward Tolman no estudo \label{tolman}
...
\begin{figure}[t]
 \includegraphics[width=\textwidth]{./imgs/image011.jpg}
...
exigido do rato em busca de alimento no labirinto de \index{Tolman, Edward}Tolman. Imagem
...
Uma forma bastante eficaz de esconder a verdade é a fragmentação dos eventos de forma que não se possa mais juntar os pedaços, a não ser por aqueles que a fragmentaram. Daí a necessidade de uma método de ação que tenha por objetivo justamente a reconexão das partes com o todo. Nesse sentido, apesar de todo esforço de especialização em determinados assuntos, precisamos aprender também a juntar as partes, recolher os cacos, soldar os fios e preencher as fissuras.
...
superá"-lo.\footnote{\index{Jameson, Fredric}Jameson (1988, p.~47) chega a comparar o mapeamento cognitivo com a proposta pedagógica do teatro épico de Brecht. Ver página \pageref{verfremdungseffekt}.}
...
nossa capacidade de imaginação e de memória, reduzida a um mero ``repositório de imagens e de simulacros'' (\versal{JAMESON}, 2000, p.~143). Lutar contra isso deveria ser um projeto
urgente.
...
\part[\footnotesize\MakeUppercase{\textbf{MAPAS, TERRITÓRIOS}}]{\Formular{Mapas, territórios}}

\chapter[Você está aqui]{Você está\vspace{-.15cm}\break aqui}
\hedramarkboth{VOCÊ ESTÁ AQUI}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image012.jpg}
...
\index{Harvey, David}David Harvey (2001, p.~220, trad.~minha), segundo a qual ``a cartografia \label{harvey}
...
significado se anulam mutuamente.\footnote{Refiro"-me ao signo bipartido
  ...
  \index{Saussure, Ferdinand de}Ferdinand de Saussure.} Esse paradoxo ficou mais conhecido
...
ciencia} (1946), de \index{Borges, Jorge Luis}Jorge Luis Borges.\footnote{O texto foi publicado
  ...
  Libro Cuarto, Cap. \scalebox{.8}{XLV}, Lérida, 1658''.} O texto, de apenas um parágrafo, fala de um império onde a arte da cartografia
...
\index{Baudrillard, Jean}Baudrillard enxergou nessa situação \label{saturacao}
...
professor \index{Fabbrini, Ricardo}Ricardo Fabbrini (2016, p.~246) chama de ``déficit ontológico'' ---, não resta \label{deficit}
...
imersão nos mapas, as vistas aéreas e a modelagem \versal{3D} dos edifícios,
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image013.jpg}
...
\begin{quote}
Ele nos trouxe um grande mapa representando o mar,\\
Sem o menor vestígio de terra:\\
E a tripulação ficou muito contente quando perceberam\\
Que era um mapa que todos entendiam.\\[8pt]
``De que servem os Polos e Equadores de \index{Mercator, Gerardo}Mercator,\\
Trópicos, Zonas e Meridianos?''\\
Assim gritava o capitão Bellman: e a tripulação respondia,\\
``São apenas signos convencionais!''\\[8pt]
``Outros mapas têm formas, com suas ilhas e cabos!\\
Mas gostaríamos de agradecer nosso bravo capitão''\\
(Gritava a tripulação) ``pois ele nos trouxe o melhor ---\\
Uma perfeita e absoluta folha em branco!''
\end{quote}
...
\begin{figure}[ht!]
\includegraphics[width=\textwidth]{./imgs/image014.jpg}
\caption{\tiny{\Formular{Henry Holiday. {\slsc{Ocean-Chart}} ou {\slsc{Mapa de Bellman}}\break (1876). Ilustração para a primeira edição\break de {\slsc{A caçada do Snark}}, de \index{Carroll, Lewis}Lewis Carroll}}}
\end{figure}
...
proposto por \index{Deleuze, Gilles}Deleuze e \index{Guattari, Félix}Guattari. O rizoma, como vimos, é uma estrutura
sem começo nem fim cujo acesso se dá sempre pelo \emph{meio} pois, na
verdade, todas as suas múltiplas entradas são \emph{meio}. Nesse
...
mesmo, cheios de possibilidades imaginativas.\footnote{Ver página \pageref{vague}.} Para \index{Deleuze, Gilles}Deleuze e \index{Guattari, Félix}Guattari, oceanos, desertos e estepes (ao contrário da cidade, espaço \emph{estriado}) são espaços \emph{lisos}, territórios do nômade, esse sujeito incontrolável e imprevisível que, justamente por isso, desafia o poder do Estado.

O vazio do oceano coloca em xeque uma das funções mais importantes dos
...
e \index{Guattari, Félix}Guattari chamariam essa ordenação do território de \emph{estriamento}
...
\chapter[{\italic{Atlante}}, de Luigi Ghirri]{{\italic{Atlante}}, de\vspace{-.15cm}\break Luigi Ghirri} % (1973)
\hedramarkboth{ATLANTE, DE LUIGI GHIRRI}{}
...
\index{Ghirri, Luigi}Ghirri nos leva para uma espécie de odisseia onde cada fotografia é uma ilha ou uma aventura possível, como no texto de \index{Homero}Homero.

\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image015.jpg}
\caption{\tiny{\index{Ghirri, Luigi}\Formular{Luigi Ghirri. {\slsc{Atlante}} (1973)}}}
\end{figure}
...
O atlas é um objeto tão fascinante quanto o próprio mapa.\footnote{O
  ...
  da contemplação.} E não é simplesmente uma coleção de mapas, mas um
...
\chapter[Mapeamento como aventura]{Mapeamento \vspace{-.15cm}\break como aventura}
\hedramarkboth{MAPEAMENTO COMO AVENTURA}{}
...
proporcional à intensidade do esquecimento''.\footnote{Há quem veja na
  ...
  ``ya no percibiré el universo, percibiré el Zahir'' (2007, v. \scalebox{.8}{II}, p.~715). No mesmo sentido, para \index{Virilio, Paul}Paul Virilio (1993, p.~81), o esquecimento é
...
\begin{quote}
\forceindent{}1. Cumprir o trajeto de Paris a Marselha sem sair nem uma vez da
estrada.

2. Explorar cada uma das paradas, duas por dia, passando sempre a noite
na segunda, sem exceção.

3. Realizar levantamentos científicos de cada parada, tomando nota de
todas as observações pertinentes.

4. Inspirando"-se nos relatos de viagem dos grandes exploradores do
...
Tour''); pode ser um retorno (a \emph{Odisseia}) ou uma fuga (a viagem de D.\,João \versal{VI} ao Brasil), mas sempre implica a ideia de \emph{experiência}. O
...
\movetooddpage
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{./imgs/image016.jpg}
\caption{\tiny{\Formular{Tela do aplicativo {\slsc{Waze}}}}}
\end{figure}

\chapter{Pré-cartografias}
\hedramarkboth{PRÉ-CARTOGRAFIAS}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image018.jpg}
...
criativo da prática de mapeamento. Nesse 
contexto, o grupo situacionista
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image019.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image020.jpg}
\caption{\tiny{\Formular{{\slsc{Mapa de Bedolina}} (1 milênio a.C.)}}}
\end{figure}

O mapa de \index{Debord, Guy}Debord, além das relações com os ``itinerários'' romanos, é
...
definição de cartografia de \index{Harvey, David}David Harvey.\footnote{Ver página \pageref{harvey}.}
...
\begin{figure}[t!]
\includegraphics[width=\textwidth]{./imgs/image021.jpg}
\caption{\tiny{\Formular{Linhas de Nazca (entre 700 a.C. e 200 d.C.)}}}
\end{figure}

\chapter[{\italic{Costruzione legittima}}]{{\italic{Costruzione\vspace{-.15cm}\break legittima}}}
\hedramarkboth{COSTRUZIONE LEGITTIMA}{}
...
supor um observador igual a todos os outros, parado num chão estável,
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image022.jpg}
...
\chapter[Canaletto e Velázquez]{Canaletto e\vspace{-.15cm}\break Velázquez}
\hedramarkboth{CANALETTO E VELÁZQUEZ}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image023.jpg}
...
\emph{Las Meninas} (simulações computadorizadas da cena em \versal{3D} mostram
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image024.jpg}
...
\chapter[A imagem estilhaçada]{A imagem\vspace{-.15cm}\break estilhaçada}
\hedramarkboth{A IMAGEM ESTILHAÇADA}{}
...
reparar, graças ao congelamento fotográfico, numa série de movimentos  
do
...
longo da primeira metade de século \versal{XX}. A fotografia começa a mostrar  aquilo que o olho humano não é capaz de ver, as colagens e a pintura abstrata ignoram por completo a própria ideia de profundidade, a montagem cinematográfica articula tempos e espaços\linebreak

\begin{figure}[H]
\includegraphics[width=\textwidth]{./imgs/image025.jpg}
\caption{\tiny{\Formular{\index{Duchamp, Marcel}Marcel Duchamp. {\slsc{Nu descendo uma escada nº~2}} (1912)}}}
\end{figure}

\noindent{}de uma forma nunca antes vista.\footnote{Vale lembrarmos aqui do texto"-manifesto escrito pelo cineasta soviético \index{Vertov, Dziga}Dziga Vertov, que revolucionou a técnica \label{vertov} cinematográfica com o filme {\slsc{Um homem com uma câmera}} (1929), utilizando múltiplas exposições, câmera lenta, cortes, telas divididas e ``travellings'', entre outras inovações: ``Eu sou o cine"-olho, sou um olho mecânico. Eu, uma máquina, mostro a você o mundo da maneira que somente eu posso ver.// Hoje, e para todo o sempre, me liberto da imobilidade humana, estou em movimento constante, me aproximo, e então me afasto dos objetos, me arrasto para debaixo deles, subo neles. Avanço passo a passo com o focinho de um cavalo a galope, mergulho fundo numa multidão, ultrapasso soldados a correr, caio de costas, alço voo com um avião, mergulho e voo junto com corpos que mergulham e voam. Agora eu, uma câmera, me lanço com suas resultantes, manobrando no caos do movimento, gravando o movimento, começando com movimentos compostos pelas mais complexas combinações.// Livre da regra de 16"-17 quadros por segundo, livre dos limites de tempo e espaço, uno quaisquer pontos do universo, não importando onde os gravei.// Meu caminho leva à criação de uma nova percepção do mundo. Decifro, de uma nova maneira, um mundo desconhecido para você''. Ver \scalebox{.8}{MICHELSON}, Annette (ed.). {\slsc{Kino"-Eye: The Writings of \index{Vertov, Dziga}Dziga Vertov}}. Berkeley: University of California Press, 1984, p.~17 (trad. minha a partir da versão inglesa). Publicado originalmente em 1923 na revista de vanguarda {\slsc{\scalebox{.8}{LEF}}} ({\slsc{Frente de esquerda das artes}}), fundada por \index{Brik, Osip}Osip Brik e \index{Maiakovski, Vladimir}Vladimir Maiakovski.} No
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image026.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image027.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image028.jpg}
\caption{\tiny{\Formular{\index{Dibbets, Jan}Jan Dibbets. {\slsc{Perspective correction}} (1968)}}} 
\end{figure}

\chapter[As coisas como elas são]{As coisas como\vspace{-.15cm}\break elas são}
\hedramarkboth{AS COISAS COMO ELAS SÃO}{}
...
ali.\footnote{O fotógrafo norte"-americano \index{Adams, Ansel}Ansel Adams comparava a
  ...
  {\slsc{interpretar}} o negativo a sua maneira.}
...
suficiente para poder enxergá"-la por inteiro. O diapositivo da \emph{Blue marble}, seguramente guardado pela \versal{NASA} como um pequeno tesouro de valor incalculável, é a materialização de uma das mais raras e belas imagens já vistas por um ser humano. Essa imagem do planeta Terra contida nesse pedaço de plástico evoca a própria definição de aura \index{Benjamin, Walter}benjaminiana (1985, p.~170), ou seja, ``aquilo que permanece distante por mais próximo que esteja''.
...
é este objeto único que, de fato, ``esteve lá''. Essa película levada ao espaço é a testemunha material do noema fotográfico proposto por \index{Barthes, Roland}Roland Barthes sob a fórmula do ``isso foi'', ou seja, o reconhecimento da realidade passada a partir da imagem fotográfica.
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image029.jpg}
\caption{\tiny{\Formular{\index{Apollo 17}Apollo 17. {\slsc{Blue Marble}} (1972)}}} 
\end{figure}
...
película, geralmente um negativo.\footnote{Os concursos de fotografia
  muitas vezes exigiam dos premiados a apresentação do negativo como
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image030.jpg}
\caption{\tiny{\Formular{\index{Gursky, Andreas}Andreas Gursky. {\slsc{Montparnasse}} (1993)}}} 
\end{figure}
...
anulando a própria realidade com seu poder de sedução.\footnote{Hiper"-realismo
  é também um movimento artístico que tem origem nos anos 1960,
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image031.jpg}
\caption{\tiny{\Formular{\protect\scalebox{.8}{NASA}. {\slsc{Blue Marble}} (2012)}}} 
\end{figure}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image032.jpg}
\caption{\tiny{\Formular{\index{Gursky, Andreas}Andreas Gursky. {\slsc{Chicago Board of Trade}} \protect\scalebox{.8}{II} (1999)}}} 
\end{figure}
...
\chapter[O «olho que tudo vê»]{O «olho que\vspace{-.15cm}\break tudo vê»}
\hedramarkboth{O «OLHO QUE TUDO VÊ»}{}
...
softwares de modelagem \versal{3D} e de ``renderizações'' passam a produzir e
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image033.jpg}
\caption{\tiny{\Formular{{\slsc{Apple Maps}}. Modelagem digital da cidade de Paris (2018)}}}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image034.jpg}
...
como nos mapas antigos, mas agora de forma dissimulada.\footnote{Em
  ...
  podemos estender ao universo dos mapas (\scalebox{.8}{SEABROOK}, 1994, p.~48).} Conforme
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image035.jpg}
...
\chapter[Navegar é preciso]{Navegar\vspace{-.15cm}\break é preciso}
\hedramarkboth{NAVEGAR É PRECISO}{}
...
problema da representação do espaço visual \versal{3D} na tela de pintura \versal{2D}
...
Numa sociedade em que as coisas estão \linebreak

\begin{figure}[H]
\includegraphics[width=\textwidth]{./imgs/image025.jpg}
\caption{\tiny{\Formular{Telas do jogo {\slsc{Pokémon \protect\scalebox{.8}{GO}}}}}}
\end{figure}

\noindent{}constantemente em movimento, novas
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image038.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image039.jpg}
...
%\addcontentsline{toc}{part}{\footnotesize\MakeUppercase{\textbf{Práticas\,\,artísticas\,\,de}}\protect\break\MakeUppercase{\textbf{ mapeamento}}}
\part[\footnotesize\MakeUppercase{\textbf{PRÁTICAS ARTÍSTICAS DE MAPEAMENTO}}]{\Formular{Práticas artísticas\break de mapeamento}}


\chapter[Arte como pergunta]{Arte como\vspace{-.15cm}\break pergunta}
\hedramarkboth{ARTE COMO PERGUNTA}{}
...
\chapter[Práticas artísticas de mapeamento]{Práticas artísticas\vspace{-.15cm}\break de mapeamento}
\hedramarkboth{PRÁTICAS ARTÍSTICAS}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image040.jpg}
\caption{\tiny{\Formular{\index{Lombardi, Mark}Mark Lombardi. {\slsc{World Finance\break Corporation and Associates}} (1992)}}}
\end{figure}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image041.jpg}
\caption{\tiny{\Formular{\index{Fahlström, Öyvind}Öyvind Fahlström. {\slsc{Section of World\break Map – A Puzzle}} (1973). Detalhe}}}

\end{figure}

Há artistas que se relacionam com a ideia de mapa de forma indireta, às
vezes inconscientemente, como podemos ver nas abstrações radicais de \index{Malevich, Kazimir}Kazimir Malevich ou nas pinturas da última fase de \index{Pollock, Jackson}Jackson Pollock. Essas últimas compartilham com o mapa o desejo de
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image042.jpg}
\caption{\tiny{\Formular{\index{Pollock, Jackson}Jackson Pollock. {\slsc{One: Number 31, 1950}} (1950)}}}
\end{figure}

Há ainda outra prática de mapeamento, talvez a mais elementar de todas.~Trata"-se dos artistas que se utilizam do levantamento cartográfico como
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image043.jpg}
\caption{\tiny{\Formular{\index{Malevich, Kazimir}Kazimir Malevich. {\slsc{Quadrado negro}} (1915)}}}
\end{figure}

\chapter{Labirintos}
\hedramarkboth{LABIRINTOS}{}
...
\index{Borges, Jorge Luis}Borges era grande admirador de
  ...
  escritor clásico de nuestro atormentado y extraño siglo'' (\versal{BORGES},
  ...
  concepción del pasado, como ha de modificar el futuro'' (\versal{BORGES},
  2007b, p.~107).
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image044.jpg}
...
Justamente, nos labirintos de \index{Borges, Jorge Luis}Borges, a experiência subjetiva do
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image045.jpg}
...
labirinto, \index{Borges, Jorge Luis}Borges adota a perspectiva panorâmica.
...
está tão distante a ponto de ser completamente inacessível.\footnote{Kafka pode ser considerado, nesse sentido, um precursor das distopias modernas, como {\slsc{1984}} (1948), de \index{Orwell, George}George Orwell.} Kafka não se
...
como o rato de laboratório no labirinto de \index{Tolman, Edward}Tolman.\footnote{Ver página \pageref{tolman}.} Trata"-se precisamente
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image046.jpg}
...
por que razão na grande maioria das fotografias de \index{Atget, Eugène}Atget não há ninguém. Apesar
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image047.jpg}
\caption{\tiny{\Formular{\index{Atget, Eugène}Eugène Atget. {\slsc{Coin Rue de Seine}} (1924)}}}
\end{figure}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image048.jpg}
...
``coleção'' de \index{Atget, Eugène}Atget, da mesma forma que o \emph{Atlas Mnemosyne}
...
também é preciso para percorrer a cidade.\footnote{Nesse sentido, o
  ...
  \index{Atget, Eugène}Atget nunca primaram pelo esmero técnico.} Essa atitude de \index{Atget, Eugène}Atget é
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image049.jpg}
...
pelos \index{Becher, Bernd e Hilla}Bechers, uma alta carga de afetividade que move os fotógrafos em busca não apenas de registrar as estruturas que vão desaparecer, mas também de reencontrar as próprias memórias que passaram por um período violentíssimo nos anos imediatamente anteriores. Dessa forma, o trabalho
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image050.jpg}
...
Há um termo em inglês que tenta dar conta dessa abordagem. O verbo ``\emph{to
...
Os \index{Becher, Bernd e Hilla}Bechers parecem colocar a fotografia a serviço da ``visão correta'', 
...
Podemos traçar a origem desse impulso classificatório nas ciências \label{grid}
...
de serem comparados.\footnote{Grandes viajantes"-cientistas alemães, como \index{Humboldt, Alexander von}Alexander von Humboldt (1769--1859), por exemplo, se empenharam nessa tarefa, sobretudo em países pouco explorados na época, como o Brasil.} Para os \index{Becher, Bernd e Hilla}Bechers, assim como para esses cientistas,
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image051.jpg}
...
bidimensionalidade fotográfica, e prefigurando as ferramentas \versal{3D} das
...
ideia que evoca a famosa frase de \index{Klee, Paul}Paul Klee (2001, p. 73): ``a arte não
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{./imgs/image052.jpg}
\caption{\tiny{\Formular{\index{Becher, Bernd e Hilla}Bernd e Hilla Becher. {\slsc{Sternbuschweg 362}} (1972)}}}
\end{figure}
...
\chapter[{\italic{Elefante}}, de Gus Van Sant]{{\italic{Elefante}}, de\vspace{-.15cm}\break Gus Van Sant} %(2003)
\hedramarkboth{ELEFANTE, DE GUS VAN SANT}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image053.jpg}
...
exatamente como o rato no labirinto de \index{Tolman, Edward}Tolman.\footnote{Ver página \pageref{tolman}.} Há, portanto, uma
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image054.jpg}
...
juntamente com \emph{Wolfenstein 3\versal{D}} (1992) --- popularizou
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image055.jpg}
\caption{\tiny{\Formular{Id Software. {\slsc{Wolfenstein 3}}\protect\scalebox{.8}{D} (1992)}}}
\end{figure}

\chapter[{\italic{Spin out}}, de Richard Serra]{{\italic{Spin out}}, de\vspace{-.15cm}\break Richard Serra} % (1973)
\hedramarkboth{SPIN OUT, DE RICHARD SERRA}{}

Para alcançar a obra \emph{Spin out} (1973), de
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image058.jpg}
\caption{\tiny{\Formular{\index{Serra, Richard}Richard Serra. {\slsc{Spin out}} (1973). Museu Kröller"-Müller, Holanda}}}
\end{figure}
...
observação.\footnote{Na fotografia, a paralaxe acontece em câmeras de visor indireto, ou seja, aquelas em que (diferentes das {\slsc{reflex}}) o visor e objetiva são dois dispositivos distintos, um próximo ao outro, que enquadram a mesma cena à frente. Enquanto o olho vê a cena através do visor, a imagem é capturada através da objetiva, gerando um pequeno desvio entre o que se viu e a fotografia resultante.} Esse efeito dialético faz o observador perceber a
...
\chapter[Fotografar para ver]{Fotografar\vspace{-.15cm}\break para ver}
\hedramarkboth{FOTOGRAFAR PARA VER}{}
...
Na Land Art, ao contrário, muitas vezes o registro
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image064.jpg}
...
jetty} (1970), de \index{Smithson, Robert}Smithson, a mais emblemática obra da Land Art, é mais conhecida pelas imagens aéreas, que
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image065.jpg}
...
(1995) de \index{Christo e Jeanne-Claude}Christo e Jeanne"-Claude, é um cartão"-postal que, ao mesmo tempo em que se esconde, pede para ser
...
A \emph{Spiral jetty} (1970) permite duas leituras principais: pode ser experimentada
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image066.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image067.jpg}
\caption{\tiny{\Formular{\index{Maria, Walter De}Walter De Maria. {\slsc{Vertical earth kilometer}} (1977)}}}
\end{figure}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image068.jpg}
...
cujos referentes não estão bem definidos.\footnote{Para \index{Wisnik, Guilherme}Guilherme Wisnik (2012b, p.~82), a
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image069.jpeg}
...
\chapter[O corpo como lápis]{O corpo\vspace{-.15cm}\break como lápis}
\hedramarkboth{O CORPO COMO LÁPIS}{}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image070.jpg}
...
de arte'' (\versal{KIRKPATRICK}, 1997, p.~41).
...
fosse a última pessoa no mundo, não haveria razão para fazer arte'' (\versal{ROTTENBERG}, 2014, trad.~minha).
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image071.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image072.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image073.jpg}
\caption{\tiny{\Formular{\index{Hsieh, Tehching}Tehching Hsieh. {\slsc{One year performance\break 1981–1982 (Outdoor piece)}}}}}
...
\part[\footnotesize\MakeUppercase{\textbf{A CIDADE COMO LABORATÓRIO}}]{\Formular{A cidade como\break laboratório}}

\chapter[{\italic{Cidade/city/cité}}, de Augusto de Campos]{{\italic{Cidade/city/cité}}, de\vspace{-.15cm}\break Augusto de Campos} % (1963)
\hedramarkboth{CIDADE/CITY/CITÉ}{}
...
\chapter[{\italic{As cidades invisíveis}}, de Italo Calvino]{{\italic{As cidades invisíveis}},\vspace{-.15cm}\break de Italo Calvino} % (1972)
\hedramarkboth{AS CIDADES INVISÍVEIS}{}
...
fascinante pelo estímulo à imaginação que proporciona.\footnote{O livro foi um
  ...
  ainda anterior à invenção da imprensa e forjou o imaginário do Ocidente sobre o Oriente até o século \scalebox{.8}{XVI}.}
...
há relação direta entre as cidades reais e o relato de Marco \index{Polo, Marco}Polo.
...
espera e há cidades nas quais não podemos confiar. \index{Calvino, Italo}Calvino faz uso dessas
...
\chapter[A tribuna da vida moderna]{A tribuna da\vspace{-.15cm}\break vida moderna}
\hedramarkboth{A TRIBUNA DA VIDA MODERNA}{}
...
máquina em funcionamento.\footnote{O filme foi bastante influente a
  ...
  \index{Kemeny, Adalberto}Adalberto Kemeny.} O filme retrata o período de um dia na capital
...
A Berlim de \index{Ruttmann, Walter}Ruttmann não é exatamente a cidade que não
...
baixo.\footnote{Na mitologia grega, Ícaro era filho de Dédalo, o
  ...
  próximo do sol, mas o filho desobedeceu e a cera que sustentava as
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image075.jpg}
...
\index{Harvey, David}Harvey e tantos outros.\footnote{Ver página \pageref{ruptura}.} Bob Cuspe sobe no prédio, mas mesmo assim não
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image076.jpg}
...
\index{Solà-Morales, Ignasi de}\index{Solà-Morales, Ignasi de}Ignasi de Solà"-Morales (2002, p.~126) para descrever esses
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image077.jpg}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image078.jpg}
\caption{\tiny{\Formular{Civitates orbis terrarum. {\slsc{Mapa de Jerusalém}}}}}
\end{figure}
...
palavras do arquiteto holandês \index{Koolhaas, Rem}Rem Koolhaas (2011, p.~72).
...
(referindo"-se à máxima de \index{Rohe, Mies van der}Mies van der Rohe ``menos é mais''). Para ele, a principal característica dessa cidade é a perda de
...
excelência. A urbanista \index{Rolnik, Raquel}Raquel Rolnik (2003. pp.~75--76) refere"-se à imposição de uma
...
essas perguntas imediatamente). \index{Peixoto, Nelson Brissac}Brissac (1996, p.~398) vai ainda mais longe: ``a
...
Na ausência de qualquer possibilidade dessa harmonia, \index{Peixoto, Nelson Brissac}Brissac (1996,
...
\index{Deleuze, Gilles}Deleuze e \index{Guattari, Félix}Guattari, \index{Peixoto, Nelson Brissac}Brissac tenciona substituir o binômio
...
(pós"-moderna) de \index{Virilio, Paul}Virilio, \index{Koolhaas, Rem}Koolhaas, \index{Wenders, Wim}Wenders, \index{Peixoto, Nelson Brissac}Brissac e \index{Habermas, Jürgen}Habermas
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image079.jpg}
\caption{\tiny{\Formular{\index{Vieira, Tuca}Tuca Vieira. {\slsc{Los Angeles}} (2019)}}}
\end{figure}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image080.jpg}
\caption{\tiny{\Formular{\index{Vieira, Tuca}Tuca Vieira. {\slsc{Jacarta}} (2018)}}}
\end{figure}

Em \emph{A cidade dos ricos e a cidade dos pobres}, o urbanista italiano \index{Secchi, Bernardo}Bernardo Secchi fala de ``injustiças espaciais'', decorrentes dessas distorções. As cidades não vão parar de crescer e sua configuração física e humana será um espelho da injustiça
...
\chapter[A cidade da imagem]{A cidade\vspace{-.15cm}\break da imagem}
\hedramarkboth{A CIDADE DA IMAGEM}{}
...
Segundo \index{Flusser, Vilém}Vilém Flusser (2002, p.~9), as imagens precisam ser
...
\index{Riefenstahl, Leni}Riefenstahl), a Stalinallee (\index{Marx, Karl}hoje Karl"-Marx"-Alle) em Berlim,
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image081.jpg}
...
curtíssimo'' (1992, p.~54).\footnote{O texto original é um artigo
  ...
  integrando o livro {\slsc{Amores difíceis}} (1970) com o título {\slsc{A
    aventura de um fotógrafo}}.}

\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image083.jpg}
...
\chapter[1982/2019/2049 \bigskip]{1982/2019/2049}
\hedramarkboth{1982/2019/2049}{}
...
\emph{simulacro}, proposto por \index{Baudrillard, Jean}Jean Baudrillard na mesma época do filme.
...
um ``jogo aleatório dos significantes'', na expressão de \index{Jameson, Fredric}Fredric Jameson
...
menos, o romance \emph{Frankenstein} (1818), de \index{Shelley, Mary}Mary Shelley ou o filme
\emph{Metropolis} (1927), de \index{Lang, Fritz}Fritz Lang. Esses seres, apesar de
...
Trinta e cinco anos depois (lembremos que o primeiro \emph{Blade Runner}
se passa no então distante ano de 2019), foi lançada a sequência
\emph{Blade Runner 2049}, dirigida por \index{Villeneuve, Denis}Denis Villeneuve, proporcionando
...
proposto por \index{Baudrillard, Jean}Baudrillard. Será esse simulacro característico da
pós"-modernidade ainda válido para entendermos a imagem digital no século
\versal{XXI}, com sua inédita e poderosíssima capacidade de reprodução e difusão?
...
de 1982, repetindo a proposta estética que consagrou a obra de \index{Scott, Ridley}Ridley
...
palavras de \index{Baudrillard, Jean}Baudrillard (1991, p.~185), tanto a sedução fria, do
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image084.jpg}
\caption{\tiny{\Formular{\index{Villeneuve, Denis}Denis Villeneuve. {\slsc{Blade Runner 2049}} (2017)}}}
\end{figure}
...
\index{Baudrillard, Jean}Baudrillard (1991, p.~197) ---, acaba, num ``processo circular'',
substituindo e anulando a própria realidade. É o que \index{Baudrillard, Jean}Baudrillard (1991, p.~105) chama de ``hiper"-real'', ou seja, uma imagem ``mais real que o
real''.\footnote{Ver página \pageref{hiperreal}.}

O filme atual representa uma passagem do modelo analógico para o
...
indefinidamente, segundo \index{Baudrillard, Jean}Baudrillard (1991, p. 8), ``a partir de células
...
se relaciona.\footnote{A imagem holográfica interativa vem aparecendo,
  ...
  de artistas já falecidos. Imagens assim aparecem em {\slsc{Blade Runner
    2049}}, notadamente numa cena em que um Elvis Presley virtual se
  apresenta num cassino abandonado de Las Vegas.} É o que \index{Baudrillard, Jean}Baudrillard
...
Joi e K aparentemente se apaixonam, mas, como ela é imaterial, eles não
...
possa ter uma relação sexual.\footnote{No filme {\slsc{Ela}} (2013), de
  \index{Jonze, Spike}Spike Jonze, há um encontro sexual semelhante a esse. O filme também
...
naturalização da imagem virtual. O diagnóstico de \index{Baudrillard, Jean}Baudrillard acerca do
simulacro apontava uma crítica e, portanto, uma possibilidade de
resistência às imagens hegemônicas.\footnote{Ver \scalebox{.8}{FABBRINI}, R. ``Imagem e
  enigma''. In: {\slsc{Viso: Cadernos de estética aplicada}}, v.\,\versal{X}, n.\,19
...
certa forma, já era prevista pelo próprio \index{Baudrillard, Jean}Baudrillard nos anos 1990:
...
interessado em \emph{decifrar} as imagens, como queria \index{Flusser, Vilém}Vilém
...
Joi~não~é~um~holograma~que~\emph{substitui}~a~namorada~de~K,~ela~\emph{é}~a~namorada~de~K.
...
diferente. É o que pensadores como \index{Berardi, Franco}Franco Berardi e \index{Bauman, Zygmunt}Zygmunt Bauman vêm
...
\index{Reagan, Ronald}Ronald Reagan e \index{Thatcher, Margaret}Margaret Thatcher, cujo famoso slogan ``não há
alternativa'' resume bem o espírito da época. É o que o teórico
britânico \index{Fischer, Mark}Mark Fischer chama de ``realismo capitalista'', e que \index{Jameson, Fredric}Fredric \label{realismo}
...
debilidade de nossa imaginação''.\footnote{Esta ideia ficou mais
  ...
  do que o fim do capitalismo'', atribuída tanto a \index{Jameson, Fredric}Fredric Jameson quanto
  a \index{Žižek, Slavoj}Slavoj Žižek.}

Dessa forma, podemos entender a visão de futuro de \emph{Blade Runner
...
O filósofo francês \index{Lipovetsky, Gilles}Gilles Lipovetsky considera a pós"-modernidade uma
...
Parece, portanto, que as ideias de \index{Baudrillard, Jean}Baudrillard permanecem válidas para
compreendermos o estatuto da imagem no início do século \versal{XXI}. Mais ainda,
...
representar outra coisa e podem, tal como os replicantes de \index{Scott, Ridley}Ridley
Scott, se rebelar a qualquer momento. O simulacro proposto por
\index{Baudrillard, Jean}Baudrillard dá mais uma volta do parafuso, rompendo o último fio de
...
\chapter[{\italic{Atlas\,\,fotográfico\,\,da\,\,cidade\,\,de\break São Paulo e seus arredores}} \bigskip]{{\italic{Atlas fotográfico da}}\vspace{-.15cm}\break {\italic{cidade de São Paulo}}\vspace{-.15cm}\break {\italic{e seus arredores}}}
\hedramarkboth{ATLAS FOTOGRÁFICO}{}
...
cidade tão complexa como essa. Parto do pressuposto de que a dificuldade
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image085.jpg}
...
urbana.\footnote{Em 2018, estive em Pyongyang, capital da Coreia do
  ...
  por \index{Le Corbusier}Le Corbusier na {\slsc{Carta de Atenas}}. E uma vez que a cidade pôde ser
  ...
  pensar que a legibilidade não é uma qualidade relativa apenas à
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image086.jpg}
...
população que vive junto.\footnote{Urbanistas ingleses chamam essa área
  de {\slsc{brick and mortar zone}} (zona de tijolo e argamassa).}
...
\begin{figure}[t]
\includegraphics[width=\textwidth]{./imgs/image087.png}
...
%\begin{figure}[t]
%\includegraphics[width=\textwidth]{./imgs/image088.jpg}
...
\begin{figure}[H]
\vspace*{-.5cm}
\hspace*{1.9cm}\includegraphics[width=96mm]{./imgs/atlas1b.jpg}
\end{figure}
...
\begin{figure}[H]
\vspace*{-.5cm}
\hspace*{-1.8cm}\includegraphics[width=95.2mm]{./imgs/atlas2c.jpg}
\end{figure}
\end{absolutelynopagebreak}
...
\noindent{}{\Formular\tiny{Na página anterior: Tuca Vieira. {\italic{Atlas fotográfico da cidade de São Paulo e seus arredores}}} (2014–2016).

\chapter[Referências bibliográficas]{Referências\vspace{-.15cm}\break bibliográficas}
\hedramarkboth{REFERÊNCIAS BIBLIOGRÁFICAS}{}

\vspace*{1ex}

{\Formular\small\textbf{Livros}}

\begin{bibliohedra}
\tit{ADORNO}, Theodor. {\italic{Prismas: crítica cultural e sociedade}}. São Paulo: Ática, 2001.

\tit{AGAMBEN}, Giorgio. {\italic{O que é o contemporâneo? e outros ensaios}}.
Chapecó: Argos, 2009.

\tit{AGUILAR}\mbox{ }(ed.). {\italic{Gran atlas aguilar.}} Madri: Aguilar S.A. de
Ediciones, 1969, 3\,v.

\tit{ALBERTI}, Leon Battista. {\italic{Da pintura.}} Campinas: Editora da
Unicamp, 2014.

\tit{ALPERS}, Svetlana. {\italic{A arte de descrever: a arte holandesa no
século \scalebox{.8}{XVII}}}. São Paulo: Edusp, 1999.

\tit{ALTHUSSER}, Louis. {\italic{Ideologia e aparelhos ideológicos do estado.}}
Lisboa: Editorial Presença, 1970.

\tit{AQUINO}, Lívia. {\italic{Picture Ahead: a Kodak e a construção do
turista–fotógrafo}}. São Paulo: Ed. do Autor, 2016.

\tit{ARANTES}, Otília B. Fiori. {\italic{Urbanismo em fim de linha: e outros
estudos sobre o colapso da modernização arquitetônica}}. São Paulo: Edusp, 2001.

\tit{ARGAN}, Giulio Carlo. {\italic{Arte moderna: do iluminismo aos movimentos
contemporâneos}}. São Paulo: Companhia das Letras, 1992.

\titidem. {\italic{História da arte como história da cidade.}} São
Paulo: Martins Fontes, 1993.

\titidem. {\italic{História da arte italiana: de Giotto a
Leonardo}}. São Paulo: Cosac \& Naify, 2003, 3 v. (vol. 2).

\titidem. {\italic{História da arte italiana: de Michelangelo ao
futurismo}}. São Paulo: Cosac \& Naify, 2003, 3 v. (vol. 3).

\tit{ARISTÓTELES}. {\italic{A política.}} São Paulo: Martins Fontes, 1998.

\tit{AUGÉ}, Marc. {\italic{Não"-lugares: introdução a uma antropologia de
supermodernidade}}. São Paulo: Papirus, 1994.

\tit{AUSTER}, Paul. {\italic{The new york trilogy.}} Londres: Faber And Faber,
2004.

\tit{BADGET}, Gerry. {\italic{Atget.}} Londres: Phaidon, 2001.

\tit{BARTHES}, Roland. Semiologia e urbanismo. In: \line(1,0){25}. {\italic{A
aventura semiológica.}} São Paulo: Martins Fontes, 2001, pp.~219–231.

\tit{BAUDELAIRE}, Charles. O pintor da vida moderna. In: \line(1,0){25}.
{\italic{Poesia e prosa.}} Rio de Janeiro: Nova Aguiar, 1995, pp.~851–881.

\tit{BAUDRILLARD}, Jean. {\italic{A arte da desaparição.}} Rio de Janeiro:
Editora \scalebox{.8}{UFRJ}, 1997.

\titidem. {\italic{As estratégias fatais}}. Rio de Janeiro: Rocco, 1996.

\titidem. {\italic{Da sedução}}. Campinas: Papirus, 1991. 

\titidem. {\italic{Simulacros e simulação.}} Lisboa: Relógio D'água, 1991.

\titidem. {\italic{O sistema dos objetos.}} São Paulo: Perspectiva, 2008.

\titidem. {\italic{Tela Total: Mito"-ironias da era do virtual e da imagem}}. Porto Alegre: Sulina, 1997.

\titidem. The Ecstasy of Communication. In: {\tiny{FOSTER}}, Hal (ed.). {\italic{The Anti"-Aesthetic: \scalebox{.8}{ESSAYS ON POSTMODERN CULTURE}}}. Seattle: Bay Press, 1983, p.~126–134.

\tit{BAUMAN}, Zygmunt. {\italic{Globalização: as consequências humanas}}. Rio de
Janeiro: Zahar, 1999.

\titidem. {\italic{Modernidade líquida}}. Rio de Janeiro: Zahar, 2001.

\tit{BECHER}, Bernd; {\tiny{BECHER}}, Hilla. {\italic{Tipologías.}} Madri: La Fabrica,
2010.

\titidem. {\italic{Water towers.}} Londres: The \scalebox{.8}{MIT} Press, 1988.

\tit{BENJAMIN}, Walter. {\italic{Obras escolhidas \scalebox{.8}{I}: magia e técnica, arte e
política}}. São Paulo: Brasiliense, 1985.

\titidem. {\italic{Obras escolhidas \scalebox{.8}{II}: rua de mão única}}. São
Paulo: Brasiliense, 1987.

\tit{BERARDI}, Franco. {\italic{Depois do futuro}}. São Paulo: Ubu, 2019.

\tit{BORGES}, Jorge Luis. {\italic{Obras completas \scalebox{.8}{I}: 1923–1949}}. Buenos Aires:
Emecé, 2007.

\titidem. {\italic{Obras completas \scalebox{.8}{II}: 1952–1972}}. Buenos Aires:
Emecé, 2007.

\titidem. {\italic{Obras completas \scalebox{.8}{III}: 1975–1985}}. Buenos Aires:
Emecé, 2007.

\titidem. {\italic{Obras completas \scalebox{.8}{IV}: 1975–1988}}. Buenos Aires:
Emecé, 2007.

\titidem. {\italic{Veiticinco agosto 1983 y otros cuentos.}}
Madrí: Siruela, 1988.

\tit{BOUMAN}, Ola. Re: Orientation. In: {\tiny{ABRAMS}}, Janet; {\tiny{HALL}}, Peter (ed.). {\italic{Else/Where: new cartographies of networks and territories}}.
Minneapolis: University of Minnesota Design Institute, 2006, pp.~54–57.

\tit{BRIDLE}, James. {\italic{A nova idade das trevas: a tecnologia e o fim do futuro}}. São Paulo: Todavia, 2018.

\tit{BROTTON}, Jerry. {\italic{Uma historia do mundo em doze mapas.}} Rio de
Janeiro: Zahar, 2014.

\tit{BURDETT}, Ricky; {\tiny{SUDJIC}}, Deyan (ed.). {\italic{The endless city.}} Londres:
Phaidon, 2007.

\tit{CACCIARI}, Massimo. {\italic{A cidade.}} Barcelona: Gustavo Gili, 2010.

\tit{CALVINO}, Italo. {\italic{Amores difíceis.}} São Paulo: Companhia das
Letras, 1992.

\titidem. {\italic{As cidades invisíveis.}} São Paulo: Companhia
das Letras, 1990.

\titidem. O viajante no mapa. In: \line(1,0){25}.
{\italic{Coleção de areia.}} São Paulo: Companhia das Letras, 2010.

\tit{CAMÕES}, Luís de. {\italic{Os Lusíadas.}} 4.\,ed. Lisboa: Instituto Camões,
2000.

\tit{CAMPOS}, Augusto de; {\tiny{PIGNATARI}}, Décio; {\tiny{CAMPOS}}, Haroldo de. {\italic{Teoria da poesia concreta: textos crítico e manifestos 1950–1960}}. São Paulo:
Duas Cidades, 1975.

\tit{CAMPOS}, Haroldo de. {\italic{Galáxias.}} São Paulo: Editora 34, 2004.

\tit{CARERI}, Francesco. {\italic{Walkscapes: o caminhar como prática
estética}}. São Paulo: Gustavo Gili, 2013.

\tit{CARROLL}, Lewis. {\italic{Algumas aventuras de Sílvia e Bruno.}} São Paulo:
Iluminuras, 1997.

\titidem. {\italic{The annotated Snark.}} Nova York: W.\,W.\,Norton
\& Company, 1962. Martin Gardner (ed.).

\tit{Centre Georges Pompidou}. {\italic{Cartes et figures de la terre.}}
{[}s.l.{]}, 1980.

\tit{CERTEAU}, Michel de. {\italic{A escrita da história.}} Rio de Janeiro: Forense Universitária, 2002.

\titidem. {\italic{A invenção do cotidiano: artes de fazer}}.
Petrópolis: Vozes, 1998.

\tit{CORTÁZAR}, Julio; {\tiny{DUNLOP}}, Carol. {\italic{Los autonautas de la cosmopista,
o, Un viaje atemporal París"-Marsella.}} Buenos Aires: Alfaguara, 2013.

\tit{COTRIM}, Cecilia; {\tiny{FERREIRA}}, Glória (org.). {\italic{Escritos de artistas:
anos 60/70}}. Rio de Janeiro: Jorge Zahar, 2006.

\tit{COTTON}, Charllotte. {\italic{A fotografia como arte contemporânea}}. São
Paulo: Martins Fontes, 2010.

\tit{CRAMPTON}, Jeremy W. {\italic{Mapping: a critical introduction to
cartography and \scalebox{.8}{GIS}}}. Hoboken: Wiley"-blackwell, 2010.

\tit{CRARY}, Jonathan. {\italic{24/7: capitalismo tardio e os fins do sono}}.
São Paulo: Ubu, 2016.

\tit{DARROUCH}, Michael; {\tiny{MARCHESSAULT}}, Janine (ed.). {\italic{Cartographies of
places: navigating the urban}}. Montreal: Mcgill"-queen's University
Press, 2014.

\tit{DAVIS}, Mike. {\italic{Planeta favela.}} São Paulo: Boitempo, 2015.

\tit{DELEUZE}, Gilles; {\tiny{GUATTARI}}, Félix. {\italic{Mil platôs: capitalismo e
esquizofrenia 2}}. São Paulo: Editora 34, 2011 (vol.\,1).

\titidem. {\italic{Mil platôs: capitalismo e esquizofrenia 2}}.
São Paulo: Editora 34, 2012 (vol.\,5).

\tit{DIDI"-HUBERMAN}, Georges. {\italic{Atlas: cómo llevar el mundo a cuestas?}}
Madri: Tf Editores/Museo Reina Sofía, 2010.

\titidem. {\italic{Imágenes pese a todo. Memoria visual del holocausto}}. Barcelona: Paidós, 2004.

\tit{ERBETTA}, Gabriela (ed.). {\italic{Guia ruas de São Paulo.}} São Paulo: Ed.
Abril, 2001 (Quatro"-Rodas).

\tit{FLAM}, Jack (org.). {\italic{Robert Smithson: the collected writings}}.
Berkeley: University of California Press, 1996.

\tit{FLUSSER}, Vilém. {\italic{Filosofia da caixa"-preta: ensaios para uma
futura filosofia da fotografia}}. Rio de Janeiro: Relume Dumará, 2002.

\tit{FOSTER}, Hal et al. {\italic{Art since 1900: Modernism, Antimodernism,
Postmodernism}}. Londres: Thames \& Hudson, 2016.

\titidem. O artista como etnógrafo. In: \line(1,0){25}.
{\italic{O retorno do real.}} São Paulo: Cosac \& Naify, 2014, pp.~159–186.

\tit{FOUCAULT}, Michel. {\italic{O corpo utópico, as heterotopias.}} São Paulo:
n"-1, 2013.

\titidem. Des espaces autres. In: \line(1,0){25}. {\italic{Dits
et écrits: 1954–1988, t. \scalebox{.8}{IV} (1980–1988)}}. Paris: Gallimard, 1994, pp.~752–762.

\tit{GAUL}, Guillaume Le. El ojo del arqueólogo: Atget y las formas de la
ciudad vieja. In: {\tiny{REYNAUD}}, Françoise et al (org.). {\italic{Eugène
Atget: el viejo Paris}}. Alcobendas: Tf Editores, 2011, pp.~15–29.

\tit{GHIRRI}, Luigi. {\italic{The complete essays 1973–1991}}. Londres: Mack,
2016.

\tit{GIBSON}, William. {\italic{Neuromancer.}} São Paulo: Aleph, 2016.

\tit{HALL}, Stuart. {\italic{A identidade cultural na pós"-modernidade.}} Rio de
Janeiro: Dp\&a, 2006.

\tit{HAN}, Byung"-chul. {\italic{Sociedade da transparência}}. Petrópolis: Vozes, 2017.

\titidem. {\italic{Sociedade do cansaço}}. Petrópolis: Vozes, 2015.

\tit{HARVEY}, J. B. {\italic{The new nature of maps: essays in the history of
cartography}}. Londres: Johns Hopkins University Press, 2002.

\tit{HARVEY}, J. B.; {\tiny{WOODWARD}}, D. (ed.). {\italic{The history of cartography.}}
Chicago: Chicago University Press, 1987 (v. 1).

\tit{HARVEY}, David. {\italic{Condição pós"-moderna: um estudo sobre a mudança
cultural}}. São Paulo: Loyola, 2014.

\titidem. {\italic{Para entender O capital: Livros \scalebox{.8}{II} e
\scalebox{.8}{III}}}. São Paulo: Boitempo, 2014.

\titidem. {\italic{Spaces of capital: towards a critical
geography}}. Nova York: Routledge, 2001.

\tit{HEIDEGGER}, Martin. La cosa. In: \line(1,0){25}. {\italic{Conferencias y
artículos.}} Barcelona: Ediciones del Serbal, 1994, pp.~143–159.

\tit{HOBSBAWM}, Eric. {\italic{Era dos extremos: o breve século \scalebox{.8}{XX}: 1914–1991}}. São Paulo: Companhia das Letras, 2003.

\tit{HORKHEIMER}, Max. Teoria tradicional e teoria crítica. In: {\tiny{CIVITA}}, Victor (ed.). {\italic{Os pensadores v. \scalebox{.8}{XLVIII}: textos escolhidos}}. São Paulo: Abril Cultural, 1975, p. 125–162.

\tit{HOMERO}. {\italic{Odisseia}}. Trad. Jaime Bruna. São Paulo: Cultrix, 2006.

\tit{HOUELLEBECQ}, Michel. {\italic{O mapa e o território.}} Rio de Janeiro:
Record, 2012.

\tit{HSIEH}, Tehching; {\tiny{HEATHFIELD}}, Adrian. {\italic{Out of now: the lifeworks
of Tehching Hsieh}}. Londres: Lada, 2009.

\tit{IVINS}, William M. {\italic{On the rationalization of sight: with an
examination of three renaissance texts on perspective}}. Nova York: The
Metropolitan Museum of Art, 1938.

\tit{JACQUES}, Paola Berenstein. {\italic{Apologia da deriva: escritos
situacionistas sobre a cidade}}. Rio de Janeiro: Casa da Palavra, 2003.

\titidem. {\italic{Estética da ginga: a arquitetura da favela
através da obra de Hélio Oiticica}}. Rio de Janeiro: Casa da Palavra,
2003.

\tit{JAMESON}, Fredric. {\italic{A cultura do dinheiro: ensaios sobre a
globalização}}. Petrópolis: Vozes, 2001.

\titidem. {\italic{As sementes do tempo}}. São Paulo: Ática, 1997.

\titidem. {\italic{Espaço e imagem: teorias do pós"-moderno e
outros ensaios}}. Rio de Janeiro: Editora \scalebox{.8}{UFRJ}, 2004.

\titidem. {\italic{Pós"-modernismo: a lógica cultural do
capitalismo tardio}}. São Paulo: Ática, 2000.

\titidem. Cognitive Mapping. In: {\tiny{GROSSBERG}}, Lawrence; {\tiny{NELSON}},
Cary (ed.). {\italic{Marxism and the interpretation of culture.}} Chicago:
University of Illinois Press, 1988, pp.~347–360.

\titidem. Of islands and trenches: neutralization and the
production of utopian discourse. In: \line(1,0){25}.
{\italic{Ideologies of theory 2}}. Minneapolis: University of Minnesota
Press, 1988, pp.~75–102.

\tit{KAFKA}, Franz. {\italic{La metamorfosis.}} Buenos Aires: Losada, 2001.

\titidem. {\italic{Na colônia penal}}. Rio de Janeiro: Paz e Terra, 1996.

\titidem. {\italic{Um artista da fome e a construção.}} São Paulo:
Brasiliense, 1984.

\titidem. {\italic{Um médico rural.}} São Paulo: Companhia das
Letras, 2001.

\tit{KLEE}, Paul. {\italic{Sobre a arte moderna e outros ensaios.}} Rio de
Janeiro: Zahar, 2001.

\tit{KOOLHAAS}, Rem. {\italic{Delirious New York: a retroactive manifesto for
Manhattan}}. Nova York: The Monacelli Press, 1994.

\titidem. {\italic{Três textos sobre a cidade.}} Barcelona:
Gustavo Gili, 2010.

\tit{KUNDERA}, Milan. {\italic{A lentidão.}} São Paulo: Companhia das Letras,
2011.

\tit{LATOUR}, Bruno. Redes que a razão desconhece: laboratórios,
bibliotecas, coleções. In: {\tiny{PARENTE}}, André (org.). {\italic{Tramas de
rede: novas dimensões filosóficas, estéticas e políticas da
comunicação}}. Porto Alegre: Sulina, 2004. pp.~39–63.

\tit{LE CORBUSIER}; {\tiny{JEANNERET}}, Pierre. {\italic{\OE uvre complète de 1929–1934}}.
Erlenbach: Les Éditions D'architecture, 1947.

\tit{LEFEBVRE}, Henri. {\italic{A revolução urbana.}} Belo Horizonte: \scalebox{.8}{UFMG},
2002.

\titidem. {\italic{Espaço e política.}} Belo Horizonte: \scalebox{.8}{UFMG}, 2008.

\titidem. {\italic{La production de l'espace.}} Paris: Anthropos, 1974.

\tit{LEROY}, Jean. {\italic{Atget: magicien di vieux Paris et son époque}}.
Paris: Paris Audiovisuel, 1992.

\tit{LÉVY}, Pierre. {\italic{Cibercultura.}} São Paulo: Editora 34, 1999.

\tit{LIPOVETSKY}, Gilles. {\italic{Os tempos hipermodernos}}. São Paulo: Barcarolla, 2004.

\tit{LIPPARD}, Lucy. {\italic{Overlay: contemporary art and the art of
prehistory}}. Nova York: Pantheon Books, 1983.

\tit{LOVECRAFT}, Howard Phillips. O Chamado de Cthulhu. In: \line(1,0){25}. {\italic{O horror em Red Hook}}. São Paulo: Iluminuras, 2000, pp.~103–140.

\tit{LYNCH}, Kevin. {\italic{A imagem da cidade.}} São Paulo: Martins Fontes,
1997.

\tit{MASSEY}, Doreen. {\italic{Pelo espaço: uma nova política da
espacialidade}}. Rio de Janeiro: Bertrand Brasil, 2008.

\tit{MUSIL}, Robert. {\italic{O homem sem qualidades.}} Rio de Janeiro: Nova
Fronteira, 1989.

\tit{O'ROURKE}, Karen. {\italic{Walking and mapping: artists as cartographers}}.
Londres: The \scalebox{.8}{MIT} Press, 2016.

\tit{OBRIST}, Hans Ulrich (ed.). {\italic{Mapping it out: an alternative atlas
of contemporary cartographies}}. Londres: Thames \& Hudson, 2014.

\tit{OITICICA FILHO}, César et al. {\italic{Encontros: Hélio Oiticica}}. Rio de
Janeiro: Azougue, 2009.

\tit{PANOFSKY}, Erwin. {\italic{A perspectiva como forma simbólica.}} Lisboa:
Edições 70, 1999.

\tit{PARDO}, Alona; {\tiny{REDSTONE}}, Elias (ed.). {\italic{Constructing worlds:
photography and architecture in the Modern Age}}. Londres: Prestel, 2014.

\tit{PARK}, Robert. A cidade: Sugestões para a investigação do comportamento
humano no meio urbano. In: {\tiny{VELHO}}, Otávio Guilherme (org.). {\italic{O
fenômeno urbano.}} Rio de Janeiro: Zahar, 1967, pp.~25–66.

\tit{PEIXOTO}, Nelson Brissac. {\italic{Paisagens urbanas.}} São Paulo: Senac, 1999.

\tit{PEREC}, Georges. {\italic{Espèces d'espaces.}} Paris: Galilée, 2000.

\titidem. {\italic{Tentative d'épuisement d'un lieu parisien.}}
Paris: Christian Bourgeois, 1982.

\tit{PFEIL}, Fred. Postmodernism as a 'structure of feeling'. In: {\tiny{GROSSBERG}},
Lawrence; {\tiny{NELSON}}, Cary. {\italic{Marxism and the Interpretation of
Culture.}} Chicago: University of Illinois Press, 1988, pp.~381–403.

\tit{REYNAUD}, Françoise; {\tiny{GIERTSBERG}}, Frits; {\tiny{GOLLONET}}, Carlos (org.).
{\italic{Eugène Atget: el viejo Paris}}. Alcobendas: Tf Editores, 2011.

\tit{ROBINSON}, Cervin; {\tiny{HERSCHMAN}}, Joel. {\italic{Architecture transformed: a
history of the buidings from 1839 to the present}}. Nova York: The
Architectural League of New York, 1987.

\tit{ROLNIK}, Raquel. {\italic{São Paulo.}} São Paulo: Publifolha, 2003.

\titidem. {\italic{Territórios em conflito: São Paulo: espaço,
história e política}}. São Paulo: Três Estrelas, 2017.

\tit{SANTOS}, Milton. {\italic{Metrópole corporativa fragmentada: o caso de
São Paulo}}. São Paulo: Nobel, 1990.

\titidem. {\italic{Técnica, espaço, tempo: globalização e meio
técnico"-científico"-informacional}}. São Paulo: Hucitec, 1994.

\tit{SAUSSURE}, Ferdinand de. {\italic{Curso de linguística geral.}} São Paulo:
Cultrix, 1975.

\tit{SECCHI}, Bernardo. {\italic{A cidade dos ricos e a cidade dos pobres}}. Belo Horizonte: Âyiné, 2019.

\tit{SERRA}, Richard. {\italic{Escritos e entrevistas: 1967–2013}}. São Paulo:
\versal{IMS}, 2014.

\titidem. {\italic{Writings/Interviews.}} Chicago: The University
of Chicago Press, 1994.

\tit{SIMMEL}, Georg. A metrópole e a vida mental. In: {\tiny{VELHO}}, Otávio Guilherme
(org.). {\italic{O fenômeno urbano.}} Rio de Janeiro: Zahar, 1973, pp.~11–25.

\tit{SIQUEIRA}, Henrique (org.). {\italic{Militão Augusto de Azevedo.}} São
Paulo: Cosac \& Naify, 2012.

\tit{SMITHSON}, Robert. A tour of the monuments of Passaic, New Jersey. In:
{\tiny{FLAM}}, Jack (ed.). {\italic{Robert Smithson: the collected writings}}.
Berkeley: University of California Press, 1996, pp.~58–75.

\tit{SOLÁ"-MORALES}, Ignasí de. {\italic{Territorios.}} Barcelona: Gustavo Gili,
2002.

\tit{STEYERL}, Hito. In free fall: a thought experiment on vertical
perspective. In: \line(1,0){25}. {\italic{The wretched of the screen.}}
Berlin: Sternberg Press, 2012, pp.~12–30.

\tit{STRUTH}, Thomas. {\italic{Unconscious places.}} Munique: Schirmer/mosel, 2012.

\tit{SUASSUNA}, Ariano. {\italic{Iniciação à estética.}} Rio de Janeiro: José
Olympio, 2005.

\tit{TALLY}, Robert T. Jameson's project of cognitive mapping: a critical
engagement. In: {\tiny{PAULSTON}}, Rolland G. (ed.). {\italic{Social cartography:
mapping ways of seeing social and educational change}}. Nova York: Garland
Pub, 1996, pp.~399–416.

\tit{TIBERGHIEN}, Gilles. {\italic{La nature dans l'art: sous le regard de la
photographie}}. Paris: Actes Sud, 2005.

\tit{TODOROV}, Tzvetan. {\italic{Introdução à literatura fantástica.}} São
Paulo: Perspectiva, 1992.

\tit{VIRILIO}, Paul. {\italic{A bomba informática.}} São Paulo: Estação
Liberdade, 1999.

\titidem. {\italic{O espaço crítico.}} São Paulo: Editora 34, 1993.

\titidem. {\italic{The administration of fear.}} Los Angeles: Semiotext(e), 2012.

\titidem. {\italic{Velocidade e política.}} São Paulo: Estação
Liberdade, 1996.

\tit{WALLACE}, David Foster. Alguns comentários sobre a graça de Kafka dos
quais provavelmente não se omitiu o bastante. In: \line(1,0){25}.
{\italic{Ficando longe do fato de já estar meio que longe de tudo}}. São
Paulo: Companhia das Letras, 2012, pp.~235–235.

\tit{WENDERS}, Wim. {\italic{El acto de ver: textos y conversaciones}}.
Barcelona: Paidós, 2005.

\titidem. {\italic{Once: pictures and stories}}. Nova York:
\scalebox{.8}{D.A.P.}, 2001.

\tit{WERTHEIM}, Margaret. The pearly gates of cyberspace. In: {\tiny{ELLIN}}, Nan
(ed.). {\italic{Architecture of fear.}} Nova York: Princeton Architectural
Press, 1997, pp.~295–300.

\tit{WISNIK}, Guilherme. {\italic{Dentro do nevoeiro: arquitetura, arte e
tecnologia contemporâneas}}. São Paulo: Ubu, 2018.

\titidem \mbox{ }(org.). {\italic{Encontros: Paulo Mendes da Rocha.}} Rio de
Janeiro: Beco do Azougue, 2012.

\titidem. {\italic{Espaço em obra: cidade, arte, arquitetura}}. São Paulo: Edições \scalebox{.8}{SESC}, 2018b.

\titidem. {\italic{Estado crítico: à deriva nas cidades}}. São
Paulo: Publifolha, 2009.


\tit{WOOD}, Denis. {\italic{The power of maps.}} Nova York: The Guilford Press,
1992.

\vspace*{2ex}

{\Formular\small\textbf{Periódicos}}

\tit{ANDRE}, Carl. A Note on Bernhard and Hilla Becher. {\italic{Artforum}}, New
York, dez. 1972.

\tit{ANDREWS}, J. What Was a Map? The Lexicographers Reply.
{\italic{Cartographica: The International Journal for Geographic
 Information and Geovisualization,}} {[}s.l.{]}, v. 33, n. 4, pp.~1–12, dez.
1996. University of Toronto Press Inc. (\scalebox{.8}{UTP}ress).

\tit{ANGELI}. Chiclete com banana: Bob Cuspe. {\italic{Folha de S.\,Paulo}}, São
Paulo, p.~62, 20 jun. 1986.

\tit{ARGAN}, Giulio Carlo. The Architecture of Brunelleschi and the Origins of
Perspective Theory in the Fifteenth Century. {\italic{Journal of The
Warburg And Courtauld Institutes}}, Londres, v. 9, pp.~96–121, 1946.

\tit{AUGÉ}, Marc. Assim a Internet tornou"-se a nossa divindade.
{\italic{Revista Iuh}}, {[}s.l.{]}, n.~499, pp.~1–2, 19 dez. 2016.
Entrevista publicada originalmente no jornal {\italic{La Reppublica}} em
27/07/2011. 

\tit{BAECQUE}, Antoine de. Un “Elephant” très dessiné: Comme Hitchcock ou
Fritz Lang, Van Sant affectionne croquis et
cartes. {\italic{Libération}}, Paris, 22 out. 2003.

\tit{BASTOS}, Antonio Virgílio Bittencourt. Mapas cognitivos e a
pesquisa organizacional: explorando aspectos metodológicos. {\italic{Estud. psicol.}}, Natal, v.~7, 2002.

\tit{BATAILLE}, Georges. Georges Bataille: textos para a revista {\italic{Documents}}.
{\italic{Inimigo Rumor}}, Rio de Janeiro, n.~19, pp.~78–93, 2006.

\tit{BAUDELAIRE}, Charles. O público moderno e a fotografia. {\italic{Revista
Facom}}, São Paulo, v.~17, pp.~10–14, 2007.

\tit{BAUDRILLARD}, Jean. Ecran total. {\italic{Libération}}, Paris, 6 mai. 1996b.

\titidem. Internet ruma para seu fim. {\italic{Folha de S.\,Paulo}}, São Paulo, p. e12. 19 fev. 1998.

\tit{BAUMAN}, Zygmunt. Vivemos o fim do futuro. Entrevista à revista
{\italic{Época}}, 2014. 

\tit{BENNETT}, Andrew T. D. Do animals have cognitive maps? {\italic{The
Journal of Experimental Biology}}, Cambridge, n.~199, pp.~219–224, 1996.

\tit{BONDÍA}, Jorge Larrosa. Notas sobre a experiência e o saber da
experiência. {\italic{Revista Brasileira de Educação}}, {[}s.l.{]}, n.~19,
pp.~20–28, abr. 2002.

\tit{COSGROVE}, Denis. Maps, Mapping, Modernity: Art and Cartography in the
Twentieth Century. {\italic{Imago Mundi}}, {[}s.l.{]}, v.~57, n.~1,
pp.~35–54, fev. 2005. Informa \scalebox{.8}{UK} Limited.

\tit{CORBOZ}, André. Apprendre à décoder la nébuleuse urbaine de La
Ville Au Patrimoine Urbain: Histoires de forme et de sens. {\italic{Presses de
L'université Du Québec}}, Canadá, pp.~133–138, 2011.

\tit{DELANEY}, Brigid. Tehching Hsieh, extreme performance artist: “I give
you clues to the crime”. {\italic{The Guardian}}, Londres, pp.~111–112, 24
out. 2017.

\tit{DIDI"-HUBERMAN}, Georges. Atlas: como levar o mundo nas costas?
{\italic{Sopro}}, Desterro, n.~41, pp.~3–7, 01 dez. 2010. 

\tit{FABBRINI}, Ricardo Nascimento. Estética e crítica da arte em
Jean"-François Lyotard. {\italic{O Que nos Faz Pensar: Cadernos do
Departamento de Filosofia da \scalebox{.8}{PUC}-Rio}}, Rio de Janeiro, v.~26, n.~40,
pp.~47–77, 2017.

\titidem. Imagem e enigma. In: {\italic{Viso: Cadernos de estética aplicada}}, v.\,\scalebox{.8}{X}, n.\,19 (jul–dez/2016), pp.~241–262.

\tit{FOSTER}, Hal. Postmodernism in parallax. {\italic{October}},
Cambridge, v. 63, pp.~3–20, 1993.

\tit{GIBSON}, William. William Gibson, the art of fiction No. 211. Entrevista por David
Wallace"-Wells. {\italic{The Paris Review}}, Nova York, v.~197, p.~1, 2011. 

\tit{GUERRIN}, Michel (ed.). Nous avons montrés des images qui étaient déja
composées. {\italic{Le Monde}}, Paris, p.~32, 23 maio 2001.

\tit{HARLEY}, J. B. Deconstructing the map. {\italic{Cartographica: The
...
Inc. (\scalebox{.8}{UTP}ress).

\tit{KANARINKA}, Featured Article. Art-Machines, Body-Ovens and Map-Recipes:
Entries for a Psychogeographic Dictionary. {\italic{Cartographic
Perspectives}}, {[}s.l.{]}, n.~53, pp.~24–40, 1 mar. 2006. North American
Cartographic Information Society.

\tit{KIRKPATRICK}, Colin. Interview with Richard Long: no where.
{\italic{Transcript}}, Orkney, v.~2, n.~2, pp.~38–51, 1 jan. 1997.

\tit{KOOLHAAS}, Rem. O que aconteceu com o urbanismo? {\italic{Revista Prumo:
Revista online do Departamento de Arquitetura e Urbanismo da \scalebox{.8}{PUC}-Rio}},
Rio de Janeiro, v.~1, n.~1, 2015.

\tit{LATOUR}, Bruno. Cognição e visualização. {\italic{Terra Brasilis}},
{[}s.l.{]}, n.~4, pp.~1–40, 13 fev. 2015.

\titidem. Cosmology and Class: An Interview with Bruno Latour by Nikolaj Schultz. {\italic{Critical Inquiry}}, Chicago, 13 jan. 2020. 

\tit{LESBRE}, Patrick. Le Mexique central à travers le Codex Xolotl et Alva
Ixtlilxochitl: entre l'espace préhispanique et l'écriture coloniale.
{\italic{E-spania}}, {[}s.l.{]}, n.~14, pp.~1–2, 13 set. 2012. 

\tit{LONG}, Richard. {\italic{Heaven and Earth}}. 2009. 

\tit{LONGWELL}, Dennis (ed.). Monkeys make the problem more difficult: a
collective interview with Garry Winogrand. {\italic{Image Magazine:
George Eastman House}}, Rochester, v.~15, pp.~1–4, jul. 1972.

\tit{NAYERI}, Farah. Andreas Gursky is taking photos of things that do not
exist. {\italic{The New York Times}}, Nova York, p.~C2, 29 jan. 2018.

\tit{NEGROPONTE}, Nicholas. Beyond Digital. {\italic{Wired}}, {[}s.l.{]}, n.~612, pp.~9998–9999, dez. 1998.

\tit{NOVEMBER}, Valérie; {\tiny{CAMACHO-HÜBNER}}, Eduardo; {\tiny{LATOUR}}, Bruno. Entrando em
território arriscado: O espaço na era da navegação digital.
{\italic{Terra Brasilis}}, {[}s.l.{]}, n.~2, pp.~1–22, 21 jun. 2013. 

\tit{PÉRON}, Didier; {\tiny{BERNIER}}, Alexis. Je veux tout déconstruire: Gus Van Sant
détaille la genèse d'{\italic{Elephant}} et la évolution de son rapport au
cinéma. {\italic{Libération}}, Paris, 22 out. 2003.

\tit{RANCIÈRE}, Jacques. A few remarks on the method of Jacques Rancière.
{\italic{Parallax}}, London, v.~15, n.~3, pp.~114–123, 2009. 

\tit{ROTTENBERG}, Silvia. Richard Long: turning walking into art.
{\italic{Buenos Aires Herald}}, Buenos Aires, 28 jun. 2014.

\tit{RUFÍ}, Joan Vicente. Nuevas palabras, nuevas ciudades? {\italic{Revista
de Geografía}}, Girona, n.~2, pp.~79–103, 2003.

\tit{SAFATLE}, Vladimir. Do sublime capitalista e das ruínas. {\italic{Revista
Cult}}, São Paulo, pp.~51–54, 2007.

\tit{SEABROOK}, John. E-Mail from Bill: Bill Gates's vision for the future.
{\italic{The New Yorker}}, Nova York, p.~48, 10 jan. 1994.

\tit{TIBERGHIEN}, Gilles. Imaginário cartográfico na arte contemporânea:
sonhar o mapa nos dias de hoje. {\italic{Rev. Inst. Estud. Bras}}, São
Paulo, n.~57, pp.~234–251, dez. 2013.

\tit{TILLMANS}, Wolfgang. “Lecture”. {\italic{Cine Qua Non}}, Lisboa, pp.~16–47,
2012.

\tit{TOLMAN}, Edward. Cognitive maps in rats and men. {\italic{The Psychological Review}}, 55(4), pp.~189–208, 1948.

\tit{VIRILIO}, Paul. Paul Virilio: da política do pior ao melhor das utopias e
à globalização do terror. {\italic{Revista Famecos}}, {[}s.l.{]}, v.~8, n.~16, pp.~07–18, 10 abr. 2008.

\tit{WATSON}, Ruth. Mapping and contemporary art. {\italic{The Cartographic
Journal}}, {[}s.l.{]}, v.~46, n.~4, pp.~293–307, nov. 2009. Informa \scalebox{.8}{UK}
Limited.

\tit{WISNIK}, Guilherme. Uma ordem oculta das cidades. In: {\tiny{FUNARTE}}.
{\italic{Lugares/Representações}}. São Paulo, 2011, pp.~4–8.

\tit{ZIEGLER}, Ulf Erdmann (ed.). O léxico industrial de Bernd e Hilla Becher.
{\italic{Zum}}, São Paulo, v.~01, pp.~154–179, out. 2011.


\pagebreak

{\Formular\small\textbf{Filmes}}

\tit{Bernd et Hilla Becher}. Direção de Jean"-Pierre Krief. França, 2002. Série
Contacts.

\tit{Berlim, sinfonia de uma metrópole}. Direção de Walter Ruttmann. Alemanha,
1927.

\tit{Blade Runner}. Direção de Ridley Scott. \scalebox{.8}{EUA}, 1982.

\tit{Blade Runner 2049}. Direção de Denis Villeneuve. \scalebox{.8}{EUA}, 2017.

\tit{Blow-up}. Direção de Michelangelo Antonioni. Reino Unido, Itália, \scalebox{.8}{EUA}, 1967.

\tit{Der Himmel über Berlin}. Direção de Wim Wenders. Alemanha, 1987.

\tit{Elefante}. Direção de Gus Van Sant. \scalebox{.8}{EUA}, 2003.

\tit{Metropolis}. Direção de Fritz Lang. Alemanha, 1927.

\tit{Nunca é noite no mapa}. Direção de Ernesto de Carvalho. Brasil, 2016.

\tit{O céu nos observa}. Direção de Daniel Lima. Brasil, 2010. %Disponível em: \textless{}\emph{https://bit.ly/39L2vhW}\textgreater{}. Acesso em 3. fev. 2017.

\tit{Outside again}. Direção de Adrian Heathfield e Hugo Glendinning. Itália, 2017.

\tit{Um homem com uma câmera}. Direção de Dziga Vertov. União Soviética, 1929.

\tit{Sans soleil}. Direção de Chris Marker. França, 1983.

\tit{Smithson and Serra: beyond modernism?}\mbox{ } Produção de G.d. Jayalakshmi.
Realização de Paul Wood. Reino Unido, 1992.

\tit{Tron}. Direção de Steven Lisberger. \scalebox{.8}{EUA}, 1982.
\end{bibliohedra}
