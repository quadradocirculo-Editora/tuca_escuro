...
Scott.\footnote{Adaptado a partir do romance {\slsc{Androides sonham com
  ovelhas elétricas?}} (1968), de Philip K. Dick.} Tanto Gibson quanto
...
\caption{\footnotesize{\Formular{Dan O'Bannon e Moebius. {\slsc{The long tomorrow}} (1976)}}}
%\end{minipage}
\end{figure}
...
A rebeldia juvenil e violenta dos replicantes que se opõe ao sistema é a %A rebeldia se opõe ou os replicantes se opõem?
...
da humanidade. Basta pensarmos no poder de informação centrado em %informação se repete
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Ridley Scott. {\slsc{Blade Runner}} (1982)}}}
%\end{minipage}
\end{figure}
...
(embora sejas coisas distintas). Mais recentemente, ganhou a atenção de
...
A importância do ciberespaço como um novo espaço cultural não pode ser
subestimada, pois não se trata apenas de um sistema de troca de
informações, mas de um espaço cultural desterritorializado pode tanto
...
\emph{videogames}, por exemplo) acontece dentro desse universo, e foi
...
franceses Gilles Deleuze e Félix Guattari. Para eles (2011, p. 48), o
...
como tecido a conjunção 'e\ldots{} e\ldots{} e\ldots{}'``.
...
Nossos dados são coletados para serem vendidos à publicidade dirigida,
...
Há quem diga que o ciberespaço é hoje o principal espaço de disputa
...
regulação e representatividade. Mesmo que não seja esse o nosso desejo,
...
funcionamento, sem o escrutínio do poder público, e conhecem nosso
...
nossa frente, adivinhando nossas preferências e oferecendo um novo
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Vista aérea do Vale do Silício}}}
%\end{minipage}
\end{figure}
...
nos Estados Unidos e no Brasil?\footnote{Nos Estados Unidos, a empresa
  de análise de dados e comunicação estratégica Cambridge Analytica se
  utilizou --- provavelmente de forma ilegal --- de dados pessoais
...
exatamente como numa novela cyberpunk, sem poder de ação. A imagem dessa
...
Neste início do século \versal{XXI}, o futuro parece sombrio novamente. Berardi
...
\emph{Admirável Mundo Novo} (1932), de Aldous Huxley, e \emph{Mil
novecentos e oitenta e quatro} (1948), de George Orwell, com seu
...
mundo também foi ameaçado por monstros gigantes como Godzilla~(1954),
...
própria sobrevivência em meio à escassez de recursos. Ambientado na
...
filmes como \emph{Armageddon} (1998) \emph{Impacto} \emph{Profundo}
...
busca de respostas metafísicas para fim do mundo.
...
da história para acontecer, seja uma guerra, um monstro ou uma
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Fritz Lang. {\slsc{Metrópolis}} (1927)}}}
%\end{minipage}
\end{figure}
...
humanos superinteligentes mas, a sua maneira, o \emph{cyberpunk} acerta
...
entende perfeitamente.\footnote{Esta é também a condição ``kafkiana''
  ...
  ideias --- ou melhor --- duas obsessões regem a obra de Frank Kafka. A
...
transformar a realidade, condenada a uma imediatismo paranoico. O
...
possibilidades impensáveis até então. Mas a ideia de que a democracia
encontraria no território virtual da rede finalmente seu ambiente ideal
...
desregulamentação da economia e o advento da internet.\footnote{Popularizada
  ...
  a circulação de dados que até então era restrita sistemas
...
A distopia dos anos 2010, produto direto do fracasso, nos anos 2000, da
...
No cyberpunk não há mais espaço para os heróis que podem salvar o mundo,
como em muitas histórias de ficção científica. As cidades são tomadas
por personagens individualistas, preocupados em salvarem a si mesmo, sem
...
um rizoma deleuziano, hoje talvez seja seja melhor entendê-lo
...
onde estamos.\footnote{Mesmo o ciberespaço, com toda sua virtualidade,
  ...
  refere-se à a ``um edifício funcional composto de equipamentos de
  ...
  dados entre os diversos componentes''. Ver: \emph{https://br.ccm.net/}.} Ainda
...
tornar sinônimo de impossibilidade, de fadiga e de desespero. A ausência
de barreiras aparente é apenas uma ilusão que não impede a configuração
...
deserto borgiano.\footnote{Refiro-me aqui à parábola ``Os dois reis e os
  ...
  galerías que recorrer, ni muros que veden el paso'' (\scalebox{.8}{BORGES}, 2007a, p.
  731). Ou ver página \scalebox{.8}{XXXXXX}.}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Steven Lisberger. {\slsc{Tron}} (1982)}}}
%\end{minipage}
\end{figure}

\emph{Tron} retrata o ciberespaço como um lugar onde se pode entrar, mas
de onde é difícil de sair, justamente como num labirinto. Ali dentro
...
estética própria para o universo dos computadores.\footnote{Depois
  aperfeiçoada no filme {\slsc{Matrix}} (1999), dos irmãos Wachowski.} O
...
Visto de um ponto de vista cultural, o ciberespaço seria, portanto, uma
...
do espaço.\footnote{Ver \scalebox{.8}{FOSTER}, Hal et al. {\slsc{Art since 1900:
...
justamente sua superficialidade --- uma ``falta de profundidade'' onde as
...
simulacros.\footnote{Ver \scalebox{.8}{BAUDRILLARD}, Jean. {\slsc{Simulacros e
  simulação.}} Lisboa: Relógio D'água, 1991. p. 7-58.} Esta
...
``aceleracionistas'', ou seja, são fundadas da ideia de acúmulo,
...
que nunca alcançaremos, como no paradoxo de Zenão.\footnote{O paradoxo,
  ...
  kafkiana. Ver \scalebox{.8}{BORGES}, Jorge Luis. ``Kafka y sus precursores'', in
  {\slsc{Obras completas \scalebox{.8}{II}: 1952-1972}}. Buenos Aires: Emecé, 2007, p.
  107.} Assim como os aparelhos e os softwares, nós mesmos precisamos
...
paralisia do desejo erótico de uma série de patologias contemporâneas.
...
impossível para cérebro humano acompanhar essa expansão da capacidade de
...
conversibilidade estabelecido nos acordos de Bretton Woods em 1944,
...
dobrou nesse mesmo período. Se éramos 3,9 milhões em 1972, agora somos
7,7 milhões de habitantes, segundo a \versal{ONU}.\footnote{United Nations,
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Michael Wolf. {\slsc{Architecture of density \#116}}, Hong Kong (2009)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Edward Burtynsky. {\slsc{Manufacturing \#2}}, Mudança de turno, Fábrica Yuyuan Shoe, Gaobu, China (2004)}}}
%\end{minipage}
\end{figure}
...
Pensadores como Fredric Jameson, Paul Virilio e Zygmunt Bauman,
...
condição onde ``a verdade da experiência não mais coincide com o lugar
...
fuja ao ao escopo desse livro, se não levarmos a sério o que dizem os
...
urbanismo uma vez que transforma nossa noção de espaço.\footnote{Sabemos
  ...
  síntese, de eventos e lugares''.} Para Fredric Jameson, um dos
...
em um mundo exterior mapeável'' (2000, p. 70).
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{John Portman. {\slsc{Hotel Bonaventure}} (1976)}}}
%\end{minipage}
\end{figure}
...
jamesoniano acrescidos de elementos de crueldade. Nos shoppings (que os
...
arquitetura.\footnote{Ver o documentário {\slsc{The Creators of Shopping
  Worlds}} (2001), de Harun Farocki.} O \emph{shopping} é um labirinto
...
noturnos, bares, piscinas, circo, etc. Os cassinos e os shoppings são o
...
O filósofo e urbanista francês Paul Virilio, que entende a problemática
...
\emph{espaço} \emph{liso} e \emph{espaço} \emph{estriado}. Uma leitura
...
ponto pode ser conectado a qualquer outro''. De ponto de vista do
...
as definições \emph{de espaço liso} colocadas por Deleuze e Guattari. A
...
shopping center, uma novela de Kafka, podem ser considerados espaços
...
propaganda.\footnote{O texto de Benjamin é contemporâneo dos filmes de
  propaganda nazista dirigidos por Leni Riefenstahl como {\slsc{Triunfo
    da Vontade}} (1934) e {\slsc{Olympia}} (1938), cujas inovações técnicas
  são inegáveis.} Em suma, Benjamin enxerga com entusiasmo essa nova
...
crítica é, para Benjamin (1987, p. 54), justamente ``uma questão de
...
\emph{verfremdungseffkt} (efeito de distanciamento), cujo resultado
...
Assim como Benjamin, é também através da observação dos avanços
...
a uma distância mínima, a totalidade das coisas. Heidegger (1994, p.
144) identifica o problema que os pensadores do pós-modernismo vão
desenvolver décadas depois: ``o que acontece quando, suprimindo as
grandes distâncias, tudo se torna igualmente próximo e igualmente longe?
\footnote{Hal Foster (1993) enxerga três momentos nesse processo de
...
Ainda na mesma linha, para David Harvey, as revoluções, políticas,
...
efeitos imediatos e ramificadores sobre vários outros'' (2014, p. 238).
...
``aldeia global'', um evento acontecido num lugar têm um impacto
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Reuters. Trens de alta velocidade, Wuhan, China (2012)}}}
%\end{minipage}
\end{figure}

Harvey demonstra que essa revolução já acontecia desde o século \versal{XIX} e é
parte integrante do próprio modo de funcionamento do capitalismo. O
próprio Marx já havia percebido que `` É da natureza do capital mover-se
...
anulação do espaço pelo tempo (\versal{MARX} apud \versal{HARVEY}, 2014, p. 298).
...
contemporâneo, talvez seja ``onde estamos?''\footnote{{\scalebox{.8}{De onde
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{O labirinto de Tolman e o gráfico que mostra a curva de erros dos ratos}}}
%\end{minipage}
\end{figure}
...
pelo filósofo francês Jacques Rancière:
...
de determinar as coordenadas do `aqui e agora'? (\versal{RANCIÈRE}, 2009, p.115,
trad. nossa).
...
agora foi deslocado para o mundo.\footnote{O sociólogo jamaicano Stuart
  ...
  disciplinar'' descrito por Foucault e o feminismo.} Michel Foucault é
...
(\versal{FOUCAULT}, 1994, p. 752, trad. nossa).
...
momento da história. É por isso que Marc Augé ao perceber que ``o mundo
da supermodernidade não tem as dimensões exatas da­quele no qual
pensamos viver'' alerta simplesmente sobre a necessidade de
``rea­prender a pensar o espaço'' (\versal{AUGÉ}, 1994, p. 37).
...
\emph{Cognitive maps in rats and men}, publicado em 1948,\footnote{Publicado
  revista {\slsc{The Psychological Review}}, 55(4), 1948, p. 189-208.} O
...
(\versal{BASTOS}, 2002). Para o filósofo brasileiro Nelson Brissac Peixoto (1996,
p. 408), o mapeamento é um modo de percepção não-ocular que se configura
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Kevin Lynch. Ilustrações do livro {\slsc{A imagem da cidade}}}}}
%\end{minipage}
\end{figure}
...
\partepigraph{It is not down in any map; true places never are}{Herman Melville, \emph{Moby Dick} (1851)}
...
quanto as necessidades de quem o financiou.\footnote{Diferentemente de
  ...
  Ribeiro, Gerard Mercator, Joan Blaeu e família Cassini estão entre os
...
próprio e a sua época. Basta percebermos que dois mapas do mesmo lugar,
desenhados no mesmo momento histórico, mas por autores diferentes, serão
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Abrahan Ortelius. {\slsc{Mapa da Islândia}} (séc. \versal{XVI})}}}
%\end{minipage}
\end{figure}
...
David Harvey (2001, p. 220, trad. nossa), segundo o qual ``a cartografia
...
ciencia} (1946), de Jorge Luis Borges.\footnote{O texto foi publicado
  ...
  {\slsc{Museo}}, creditado a um certo B. Lynch Davis, pseudônimo de
...
toma o lugar do em mapa, transformando-se numa representação de si
...
morto pelo imperador diante de tamanha ousadia. Borges (2007, v. \versal{II}, p.
214) sugere que bastou o poeta recitar o poema, para o palácio
...
coisa.\footnote{Na religião muitas vezes a imagem do personagem (ou o
  ...
  {\slsc{Tristes Trópicos}}. São Paulo, Cia das Letras, 1998, p. 427.}
...
adquirem ``intensidade espectral, vazia de sentido''.\footnote{Ver
  \scalebox{.8}{FABBRINI}, Ricardo Nascimento. Estética e crítica da arte em
  Jean-François Lyotard. O Que nos Faz Pensar: Cadernos do Departamento
  de Filosofia da \scalebox{.8}{PUC}-Rio, Rio de Janeiro, v. 26, n. 40, p.47-77, 2017.}
...
real que este torna, paradoxalmente, uma utopia a ser alcançada. A
...
vinculada ao erotismo e à sedução, ao sagrado e ao segredo''.\footnote{Ver
  \scalebox{.8}{FABBRINI}, Ricardo Nascimento. ``O que está acontecendo com as
  imagens?'': arte, mídia e educação em Jean
  Baudrillard. {\slsc{Filosofia e Educação}}, {[}s.l.{]}, v. 8, n. 1,
  p.63-91, 23 fev. 2016. Universidade Estadual de Campinas.}
...
imersão nos mapas, as vistas aéreas e a modelagem 3-D dos edifícios,
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Aram Bartholl. {\slsc{Map}}, Arles (2011)}}}
%\end{minipage}
\end{figure}

Outro mapa absurdo de Carroll é o famoso ``mapa de Bellman'', do poema
\emph{nonsense} \emph{A caçada do Snark} (1876) (trad. nossa):
...
``De que servem os Polos e Equadores de Mercator,\\
...
Uma perfeita e absoluta folha em branco!''\footnote{``He had brought a
...
O mapa vazio de Belmann, um mapa sem \emph{autor}, é o espaço das
possibilidades infinitas e libertário em sua essência e, por isso mesmo,
possui um potencial subversivo. O oceano de Belmann pode ser entendido
como a versão cartográfica de um \emph{terrain vague}, expressão cunhada
pelo arquiteto catalão Ignasi de Solà-Morales (2002, p. 126, trad.
nossa) para descrever espaços vazios e indeterminados mas, por isso
mesmo, cheio de possibilidades imaginativas. Ou como o \emph{espaço}
\emph{liso} por excelência. Para Deleuze e Guattari, o oceano (assim
como deserto e a estepe) é o espaço \emph{liso} por excelência (ao
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Henry Holiday, {\slsc{Ocean-Chart}} (1876). Ilustração para a primeira edição de {\slsc{A caçada do Snark}}, de Lewis Carroll}}}
%\end{minipage}
\end{figure}
...
desenhar um mapa implica numa atitude potencialmente repressora. Deleuze
...
mapas ali impressos\footnote{É exatamente o mesmo procedimento utilizado
  ...
  Houellebecq {\slsc{O mapa e o território}} (2010).}. As fotografias
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Luigi Ghirri, Série {\slsc{Atlante}} (1973)}}}
%\end{minipage}
\end{figure}
...
instrumento do conhecimento, prossegue o filósofo francês (2010a, p.
15), o atlas ``desconstrói os ideais de unidade, de especificidade, de
...
natureza igualmente libertadora e opressivas dos mapas.
...
Por exemplo, o Waze é um navegador virtual que combina sofisticados
...
pessoas sobre a localização onde se quer chegar. Não á mais preciso
prestar atenção no caminho e memorizá-lo. O Waze (e outros
...
meio do oceano de Bellmann.

\begin{figure}[!ht]
%\begin{minipage}{0,4\textwidth}
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Tela do aplicativo {\slsc{Waze}}}}}
%\end{minipage}
\end{figure}
...
e à simultaneidade enquanto o mapeamento está relacionado ao o percurso,
...
proporcional à intensidade do esquecimento''.\footnote{Há quem veja na
  ...
  ``ya no percibiré el universo, percibiré el Zahir'' (2007, v. \scalebox{.8}{II}, p.
  715). No mesmo sentido, para Virilio (1993, p. 81), o esquecimento é
  condição de possibilidade do próprio imaginário.}

Portanto, a diferença mais importante é que o mapeamento induz uma
\emph{leitura} \emph{crítica} do espaço, diferente do mapa, que sugere a
\emph{observação} \emph{utilitária} desse mesmo espaço. Nesse sentido, o
...
podemos recorrer a esta bela imagem de Michel de Certeau:
...
expedição marítima que permitiu a representação das costas. (1998, p.
206)

Certeau nos lembra que na origem do mapa está o percurso, a viagem.
...
O percurso e o deslocamento que antecedem o mapa mostra que, por trás
...
atemporal Paris-Marsella} (1983), de Julio Cortázar e Carol Dunlop. O
casal decide fazer o trajeto entre as duas cidades seguindo algumas
regras:

1. Cumprir o trajeto de Paris a Marselha sem sair nem uma vez da
estrada.
...
4. Inspirando-nos nos relatos de viagem dos grandes exploradores do
...
bordo de uma \emph{kombi} (que eles apelidaram de \emph{Fafner}, como o
...
\emph{peras} (limite). Mesmo a palavra ``pirata'' pertence a essa mesma
...
que a própria ideia de conhecimento e instrução implica também em
...
razão para a busca do conhecimento pela experiência (com o todo o risco
...
próprio quando faz este percurso e descreva a sequencia do que pode ver,
...
entre a prática do mapeamento e os mapas como conhecemos atualmente.

\begin{figure}[!ht]
%\begin{minipage}{0,4\textwidth}
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Trecho da {\slsc{Tabula Peutingeriana}} (cópia de original romano do século \versal{IV})}}}
%\end{minipage}
\end{figure}
...
pictórica pré-cartográfica.\footnote{Esses documentos pictóricos são
  ...
  retratando hábitos, movimentos migratórios e religiosidade desse povo.
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{{\slsc{Códex Xolotl}} (séc. \versal{XVI})}}}
%\end{minipage}
\end{figure}
...
inconsciente --- uma proposta estética que se opõe à flânerie
...
(como os bulevares haussmaniano), mas \emph{vetores} provisórios
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Guy Debord. {\slsc{Guide Psychogeographique de Paris: Discours Sur Les Passions D’Amour}} (1956)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Representação do {\slsc{Mapa de BedolinaMapa de Bedolina}} (1 milênio a.C.)}}}
%\end{minipage}
\end{figure}
...
como parece.\footnote{Indisputadamente, o mapa mais antigo do mundo de
  ...
  Brotton, Jerry. {\slsc{Uma história do mundo em doze mapas.}} Rio de
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Linhas de Nazca (entre 700 a.C. e 200 d.C.)}}}
%\end{minipage}
\end{figure}
...
\chapter{\emph{Costruzione leggitima}}
...
\emph{costruzione leggitima}, que apresenta o mundo \emph{diante} de
...
matemáticas do esquema, como um manual de instruções.\footnote{A
  {\slsc{Geografia}} (150 d.C.), de Ptolomeu, foi o mais importante
...
nunca de antes navegados''.\footnote{Terceiro verso da primeira estrofe
  do Canto \scalebox{.8}{I} de {\slsc{Os Lusíadas}} (1572), de Luís de Camões.}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Vittore Carpaccio. {\slsc{Retorno dos embaixadores}} (1495)}}}
%\end{minipage}
\end{figure}
...
(2003a, p. 367). Carpaccio percebe que a perspectiva é um instrumento de
...
A tela \emph{Campo Santi Giovanni e Paolo} (1735-38,) mostra um arranjo
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Canaletto. {\slsc{Campo Santi Giovanni e Paolo}} (1735--38)}}}
%\end{minipage}
\end{figure}
...
Canaletto foi um pintor bastante comercial. Seus quadros eram quase
...
\emph{costruzione leggitima} pode estar mais próxima da imaginação do
que da realidade.
...
Velázquez. O ponto de vista único também pode ser entendido como aquele
...
\emph{Las Meninas} é construído obedecendo rigorosamente as regras da
...
reagem à nossa intrusão. Velásquez inverte a relação e nos coloca no
...
esquerdo). E o pintor também nos olha. Aqui, também podemos entendê-la
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Diego Velázquez, {\slsc{Las Meninas}} (1656)}}}
%\end{minipage}
\end{figure}
...
Velásquez nos lembra que na própria natureza da arte está o artifício e
...
estudos do movimento de Étienne-Jules Maret e Eadweard Muybridge. Esses
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Marchel Duchamp. {\slsc{Nu descendo uma escada nº~2}} (1912)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Eadweard Muybridge. {\slsc{Mulher descendo a escada}} (1887)}}}
%\end{minipage}
\end{figure}


Além do cubismo, outras formas de visualizar a realidade vão surgindo ao
longo da primeira metade de século \versal{XX}. A montagem cinematográfica
...
entre a ficção representada e a realidade do público.\footnote{O mundo
  ...
  século \scalebox{.8}{XVII}, presente em várias obras da literatura como em {\slsc{As
    you like it}} (1623), de Shakespeare: ``All the world's a stage,/ And all the men and women merely players:/ They have their
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Charles Marville. {\slsc{Boulevard Saint-Germain}} (1877)}}}
%\end{minipage}
\end{figure}
...
corrections} (1967-69), a câmera transforma um quadrilátero irregular
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Jan Dibbets. {\slsc{Perspective correction}} (1968)}}}
%\end{minipage}
\end{figure}
...
desaparecem e já não é mais possível, como aponta Latour (\versal{NOVEMBER};
...
pela \versal{NASA} como um pequeno tesouro de valor incalculável, carrega consigo
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Apollo 17, {\slsc{Blue Marble}} (1972)}}}
%\end{minipage}
\end{figure}
...
se tornar imagem novamente, na tela do computador.\footnote{Evito, na
  ...
  modificar {\slsc{a posteriori}} o nome de uma prática que existiu por
  ...
  parecem mais precisos: {\slsc{photographie argentique}} (fotografia
  argêntica, referindo-se à prata utilizada como principal material
  fotossensível na emulsão das películas) e {\slsc{photographie
    numérique}} (fotografia numérica).} Com isso, a relação indicial que o
...
isoladamente em cada uma delas.\footnote{Uma câmera de 30 megapixel
  ...
  tonalidade, saturação e brilho, utilizando-se o sistema de cores \scalebox{.8}{RGB}
...
convida ao conhecimento por método de comparação.\footnote{Ver página
  \scalebox{.8}{XXXXX}.} Cada janela pode ser cotejada com as outras, todas iguais e
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Andreas Gursky, {\slsc{Montparnasse}} (1993)}}}
%\end{minipage}
\end{figure}
...
fotografia para o campo da arte contemporânea.\footnote{Opto por me
  ...
  expressão ``artistas usando o a fotografia'' com ``fotógrafos usando a
  arte'', concluindo que os discípulos do casal Becher estariam mais
  próximos dessa segunda categoria. Ver \scalebox{.8}{SOTH}, Alec. A conversation with
  Stephen Shore. {\slsc{Financial Times}}. Londres. 10 maio 2019.} Com
...
modéstia (\versal{NAYERI}, 2018). A opinião pessoal é tudo aquilo que os
...
``resolução'' digital, mais detalhes são registrados.\footnote{No filme
  {\slsc{Blow-up}} (1967), de Michelangelo Antonio, o protagonista é um
  ...
  fotografia. Em {\slsc{Blade Runner}} (1982), de Ridley Scott, há uma
...
Gursky, com a manipulação digital, leva essa capacidade intrínseca da
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{\versal{NASA}, {\slsc{Blue Marble}} (2012)}}}
%\end{minipage}
\end{figure}
...
propósitos trocados.\footnote{Ver \scalebox{.8}{WISNIK}, Guilherme. {\slsc{Dentro do
  nevoeiro: arquitetura, arte e tecnologia contemporâneas}}. São Paulo:
...
códigos de funcionamento'' (\versal{WISNIK}, 2012b, p. 33). No fundo, este é o
...
basta, que a realidade complexa em que vivemos não se dá ver tão
...
fragilidade humana.\footnote{Na última estrofe do Canto \scalebox{.8}{I} do poema épico
  {\slsc{Os Lusíadas}} (1572), o poeta português Luís de Camões oferece
  uma imagem exemplar do sublime na literatura:
``No mar tanta tormenta e tanto dano,/ Tantas vezes a morte apercebida!/ Na terra tanta guerra, tanto engano,/ Tanta necessidade avorrecida!/ Onde pode acolher-se um fraco humano,/ Onde terá segura a curta vida,/ Que não se arme e se indigne o Céu sereno/ Contra um bicho da terra tão pequeno?'' Ver \scalebox{.8}{CAMÕES}, Luís de. {\slsc{Os Lusíadas.}} 4.~ed. Lisboa: Instituto Camões, 2000, p.~27.} É uma proposta estética que se preocupa em
...
uma sequencia infinita de transformações e operações que (além de
...
pós-modernidade''\footnote{Ver \scalebox{.8}{FABBRINI}, Ricardo Nascimento. Estética e
  crítica da arte em Jean-François Lyotard. {\slsc{O Que nos Faz
    Pensar: Cadernos do Departamento de Filosofia da \versal{PUC}-Rio}}, Rio de
  Janeiro, v. 26, n. 40, p.47-77, 2017.}, que encontraria uma forma de
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Andreas Gursky, {\slsc{Chicago Board of Trade \versal{II}}} (1999)}}}
%\end{minipage}
\end{figure}
...
obra, sobretudo às abordagens de cunho marxista.\footnote{Gursky ganhou
  notoriedade depois que a obra {\slsc{99 Cent \scalebox{.8}{II} Diptychon}} (2001)
...
softwares de modelagem 3-D e de ``renderizações'' passam a produzir e
...
balão por Nadar, no século \versal{XIX}, até as imagens aéreas de supostos
...
fazer parte um novo paradigma visual com o qual estamos nos acostumando.
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Modelagem digital da cidade de Paris vista no {\slsc{Apple Maps}} (2018)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Ernesto de Carvalho, {\slsc{Nunca é noite no mapa}} (2016)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Daniel Lima, {\slsc{O céu nos observa}} (2010)}}}
%\end{minipage}
\end{figure}
...
palavra ``\versal{TERRA}'', em alusão à célebre frase do cosmonauta russo Yuri
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Carmela Gross, {\slsc{Terra}} (2017)}}}
%\end{minipage}
\end{figure}
...
transposição de um espaço tridimensional para uma superfície plana. A
problema da representação do espaço visual 3-D na tela de pintura 2-D
...
Bruno Latour (\versal{NOVEMBER}; \versal{CAMACHO-HÜBNER}; \versal{LATOUR}, 2013, p. 12), será
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Telas de celular com o jogo {\slsc{Pókemon \versal{GO}}}}}}
%\end{minipage}
\end{figure}

Não obstante, o conceito de navegação hoje abarca a tensão que existe
...
localizados no espaço real, principalmente através da aplicativos de
...
navegacional dos mapas (\versal{NOVEMBER}; \versal{CAMACHO-HÜBNER}; \versal{LATOUR}, 2013, p.
14-21).
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Alinhamento de menires de Lagatjar}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Richard Serra. {\slsc{East-West/West-East}} (2014)}}}
%\end{minipage}
\end{figure}

O escultor Richard Serra se utiliza desse tipo de marcação do território
...
espiritual.\footnote{As peças de Serra lembram o enigmático monólito do
  filme {\slsc{2001 -- Uma Odisseia no Espaço}} {[}1968{]}, de Stanley
...
\partepigraph{Penetra surdamente no reino das palavras}{Carlos Drummond de Andrade, \emph{Procura da poesia} (1945)}
...
tanto porque arte é uma das atividades humanas mais difíceis enquadrar
...
século \versal{XVIII} (para não falar na noção de arte dos povos orientais), e
assim por diante.
...
criações humanas pretendem, afinal, explicar o mundo, cada uma delas a
...
tem a contribuir para a compreensão dessa mesma questão. A pesquisa, a
...
artes, que vão utilizar estratégias distintas. Para uns, o mapeamento se
...
entre essas práticas, fazendo muitas vezes uso de mais de uma forma de
mapeamento.
...
partir dos anos 1980.\footnote{Ver Obrist, Hans Ulrich
  (ed.). {\slsc{Mapping it out: an alternative atlas of contemporary
    cartographies}}. Londres: Thames \& Hudson, 2014 e Harmon, Katharine
  (ed.). {\slsc{The map as art: contemporary artists explore
    cartography}}, Princeton Architectural Press, New York, 2009.} Se o mapa
...
Steinberg, Marcel Broodthaers, Aleksandra Mir, Leon Ferrari, entre
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Mark Lombardi {\slsc{World Finance Corporation and Associates}} (1992)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Öyvind Fahlström. {\slsc{Section of World Map -- A Pluzze}} (1973). Detalhe}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Jackson Pollock. {\slsc{One: Number 31, 1950}} (1950)}}}
%\end{minipage}
\end{figure}

Para outros artistas, o exercício de mapeamento é mais importante e, por
isso, nos interessa mais. Nessas obras, aquele que recebe a obra (o
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Joaquín Torres-García. {\slsc{Mapa invertido}} (1943)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Leon Ferrari. {\slsc{Cidade}} (1980)}}}
%\end{minipage}
\end{figure}

Na \emph{Parábola del palacio}, Borges (2007, v. \versal{II}, p. 214) fala de um
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Stanley Kubrick. {\slsc{O iluminado}} (1980)}}}
%\end{minipage}
\end{figure}
...
Nesta parábola de Kafka, o labirinto não é expresso, nem mesmo essa
palavra é usada.\footnote{A parábola é uma narrativa curta e simples
  ...
  notadamente nas pregações de Jesus.} Ele é sugerido pois, para Kafka o
...
``paredes'', ``impedem'', ``vista'', ``escadarias'', ``circulo'',
...
``pátios'', ``palácio'', ``milénios''. O labirinto de Kafka não tem
saída ou se tem (``mas isso não pode acontecer jamais, jamais''), o
mundo fora do labirinto pode ser ainda pior. A angústia é dupla: ao
...
\begin{quote}
\versal{LOS DOS REYES Y LOS DOS LABERINTOS}
...
(\versal{BORGES}, 2007a, p. 731).\footnote{O texto foi publicado pela primeira
  vez em junho de 1939 na revista {\slsc{El Hogar}}, intitulado {\slsc{Una
    leyenda arábiga.}} Era atribuído (falsamente) ao explorador inglês Sir
  ...
  o autor ainda explicava que ``los copistas intercalaron en Las mil e
  uma noches y que omitió el prudente Galland''. Há ainda outros
...
tomado levará novamente ao meio do deserto.\footnote{Se existisse um
  ...
  Bellmann. Ver p. \scalebox{.8}{XXXX}}
...
prefere permanecer dentro do labirinto. Em \emph{A construção} (1923)
...
criatura paranoica, percorrendo e construindo o labirinto junto ela. Com
...
\emph{Uma mensagem imperial} foi publicada separadamente, mas é um
...
acabamento está excluída da obra de Kafka.\footnote{Ver \scalebox{.8}{CANDIDO},
...
despida por seus celibatários, mesmo} (1915-23)\emph{,} de Marcel
...
Michelangelo para o túmulo do papa Júlio \versal{II}, o \emph{Atlas~Mnemosyne}
...
tempo}, de Joe Gould.\footnote{Uma das grandes peças jornalísticas do
  ...
  aproximadamente nove milhões duzentas e cinqüenta e cinco mil palavras
  escritas em centenas de cadernos ``desses que as crianças usam na
  escola, todos rasgados, imundos, manchados de café, gordura e
  cerveja''. Segundo Mitchell, a {\slsc{Historia Oral}} é ``uma vasta
  ...
  autor. Ver Mitchell, Joseph. {\slsc{O segredo de Joe Gould}}. São
  Paulo: Companhia das Letras, 2003.}

Mas, atendo-se à estrutura da obra de Kafka, como propõe Antonio
...
fotográficas em formato 18 x 24, documentos artísticos sobre a bela
...
informação: eu vendi toda a minha coleção de impressões fotográficas 18
x 24 ao Musée de Sculpture Comparée, Musée du Trocadero; vendi toda a
...
E. Atget.\footnote{Carta de Atget a Paul Léon, espécie de secretário de
  Estado para as Belas Artes da França, datada de 12 de novembro de
  1920. Ver Leroy, Jean. {\slsc{Atget: magicien di vieux Paris et son
    époque}}. Paris: Paris Audiovisuel, 1992, trad. nossa.}

Eugène Atget é um grande enigma da fotografia. É muito difícil saber
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Folha de rosto do livro {\slsc{Atget: Photographe de Paris}} (1930)}}}
%\end{minipage}
\end{figure}

Atget pode ser considerado um fotógrafo do século \versal{XIX}, inspirado pelo
...
teóricos da fotografia ao longo do século \versal{XX} (Walter Benjamin, Walker
...
a fotografia criativa do século \versal{XX}. Hoje, tanto a obra de Atget quanto a
...
grande reforma urbanística promovida por Napoleão \versal{III} e executada pelo
Barão Haussmann em meados do século \versal{XIX}, que derrubou bairros inteiros e
...
dos anos 1920.\footnote{O trabalho de Atget é frequentemente confundido
  com o de Charles Marville (1813-79), fotógrafo oficial da cidade, que
...
porque na grande maioria das fotografias de Atget não há ninguém. Apesar
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Eugène Atget. {\slsc{Coin Rue de Seine}} (c. 1924)}}}
%\end{minipage}
\end{figure}
...
reflete muito do caráter do colecionador. Walter Benjamin (1987, p.
235), no texto \emph{Desempacotando minha biblioteca}, afirma que para o
...
Atget realizou inúmeras belíssimas fotografias. \emph{Rue de la
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Eugène Atget. {\slsc{Rue de la Montagne Sainte-Geneviève}} (1924)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Eugène Atget. {\slsc{Versailles: Escalier de l'Orangerie}} (1901)}}}
%\end{minipage}
\end{figure}
...
Perec).\footnote{Em {\slsc{Tentativa de esgotamento de um lugar
  parisiense}}, (1974), Georges Perec senta-se ora num café, ora num
...
Atget não se interessou em fotografar a cidade vista de cima, embora
...
fotografia moderna, mesmo que a sua revelia.
...
gás, fornos de cal, casas em eixamel e parques industriais inteiros.
...
pelo Bechers, uma alta carga de afetividade que move os fotógrafos, em
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Bernd e Hilla Becher. {\slsc{Depósitos de cascalho}} (1988--2001)}}}
%\end{minipage}
\end{figure}

Se há um termo associado aos Bechers, e disparador dos mais apaixonados
e raivosos discursos sobre a natureza da fotografia, esse termo é
\emph{objetividade}. Desde a indignação de Baudelaire no século \versal{XIX} até
...
objetividade no trabalho dos Bechers.\footnote{Compartilho da opinião de
  Didi-Huberman sobre a objetividade fotográfica: ``em geral pede-se
  muito ou muito pouco às imagens. Se pedimos muito a ela --- isto é,
  ...
  simulacro, excluímos do campo histórico como tal. Ao relegá-las à
  esfera do documental, apartamos as imagens de sua fenomenologia, de
  sua especificidade, de sua própria substância''. Ver \scalebox{.8}{DIDI-HUBERMAN},
  Georges. {\slsc{Imágenes pese a todo. Memoria Visual del Holocausto}}.
  Barcelona: Paidós, 2004, p. 59 (trad. minha).}
...
(\versal{COMENIUS} apud \versal{ALPERS}, 1999, p. 201)
...
comparar, colecionar e arquivar as coisas.\footnote{Ver também o
  {\slsc{Atlas}} (iniciado em 1962), de Gerhard Richter.} O catálogo é um
instrumento científico --- portanto uma forma de conhecimento --- onde
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Descrição do Egito. Capitéis e colunadas da ilha de Philae}}}
%\end{minipage}
\end{figure}
...
monumental e inacabada obra de Sander \emph{Pessoas do século \versal{XX}}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Bernd e Hilla Becher. {\slsc{Sternbuschweg 362, Alemanha}} (1972)}}}
%\end{minipage}
\end{figure}
...
sobretudo de Carl Andre, segundo o qual essas fotografias ``registram a
...
fotografia.\footnote{Corroboro aqui considerações de Armin Zweite. Ver
  \scalebox{.8}{BECHER}, Bernd; \scalebox{.8}{BECHER}, Hilla. Tipologías. Madri: La Fabrica, 2010.}
...
Baudelaire (2007, p.13) no polêmico artigo de 1859 em que compara a
fotografia com as artes ditas mais ``nobres'':

Que ela enriqueça rapidamente o álbum do viajante e devolva a seus olhos
a precisão que faltava a sua memória, que ela ornamente a biblioteca do
...
Os Bechers fotografam seus ``objetos'' com compaixão, como se
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Gus Van Sant. {\slsc{Elefante}} (2003)}}}
%\end{minipage}
\end{figure}
...
seus próprios pontos de vista.\footnote{Como no conto {\slsc{A
  Construção}}, de Kafka, mencionado nesse capítulo.} Para isso, faz uso
...
corte.\footnote{{\slsc{Festim diabólico}} ({\slcs{Rope}}, 1948), de Alfred
  ...
  apartamento. Dois planos-sequência virtuosos se encontram em {\slsc{Soy
    Cuba}} (1948), uma produção cubano-soviética, dirigida por Mikhail
  Kalatozov. Outro exemplo é {\slsc{Arca Russa}} (2002), de Aleksandr
  Sokúrov, rodado inteiramente no Museu Hermitage, de São Petersburgo,
...
ação. Segundo o próprio diretor (\versal{BAECQUE}, 2003, trad. nossa), ``a ideia
...
Gus Van Sant confessa sua paixão pelos mapas (coleciona mapas de
...
dos mapas que os jornais publicaram'' (\versal{BAECQUE}, 2003, trad. nossa).

\begin{figure}[!ht]
%\begin{minipage}{0,4\textwidth}
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Gus Van Sant. Mapa de {\slsc{Elefante}} (2003)}}}
%\end{minipage}
\end{figure}
...
um dos personagens. O xis indica o lugar onde iniciaram o trajeto e onde
...
(\versal{BAECQUE}, 2003, trad. nossa).

O filme claramente se inspira no universo dos \emph{videogames},
...
O uso do \emph{videogame} no contexto do filme sugere a influência
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Richard Serra. {\slsc{Spin out, for Robert Smithson}} (1973). Museu Kröller-Müller, Holanda (foto: Tuca Vieira)}}}
%\end{minipage}
\end{figure}
...
nenhuma delas tem realmente um formato regular e não parecem ter as
...
mostra inútil e mesmo estúpido. A liberdade de se experimentar a obra
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Richard Serra. Detalhe de {\slsc{Spin out, for Robert Smithson}} (1973). Museu Kröller-Müller, Holanda}}}
%\end{minipage}
\end{figure}
...
revela diversos detalhes da superfície como a textura e a corrosão
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Folheto da obra {\slsc{Spin out, for Robert Smithson}} (1973). Museu Kröller-Müller, Holanda}}}
%\end{minipage}
\end{figure}
...
Land Art, movimento artístico surgido da década de 1960, bastante
...
Podemos estender essa proposta de Serra para bem além do mundo
artístico.\footnote{O fotógrafo alemão~Wolfgang Tillmans, durante uma
  ...
  sistema solar estivessem bem diante de nossos olhos''. Ver \scalebox{.8}{TILLMANS},
  Wolfgang. Lecture. {\slsc{Cine Qua Non}}, Lisboa, p.16-47, 2012.} Não
...
desde o alto. Portanto, para os artistas da Land Art, se não for
...
descontruindo sua pretensão objetiva --- eles sabem que é preciso
...
pigmentos e pincéis para o seu.\footnote{Ver página \scalebox{.8}{XXXXX}.}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Robert Smithson. {\slsc{Yucatan mirror displacements}} (1969)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Robert Smithson. {\slsc{Spiral Jetty}} (1970)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Christo e Jeanne-Claude. {\slsc{Reichstag embrulhado}} (1995)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Walter De Maria. {\slsc{Vertical Earth Kilometer}} (1977), Kassel, Alemanha (foto: Tuca Vieira)}}}
%\end{minipage}
\end{figure}

A \emph{Spiral Jetty} (1970), de Smithson --- a mais emblemática obra da
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Robert Smithson. {\slsc{Nonsite}}, Oberhausen (1968)}}}
%\end{minipage}
\end{figure}
...
representação associada aos mapas e às fotografias. Hal Foster (2014, p.
174) atribui a essas operações cartográficas e geológicas de Smithson
...
conectava o condado de Bergen com o condado de Passaic. O sol do meio
dia dava um caráter cinematográfico ao lugar, transformando a ponte e o
rio numa foto superexposta. Fotografá-los com minha Instamatic 400 foi
...
minha Instamatic. Quando cruzei a ponte, era como se eu caminhasse sobre
...
(\versal{SMITHSON}, 1996, p.70 trad. nossa).

\begin{figure}[!ht]
%\begin{minipage}{0,4\textwidth}
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Robert Smithson. {\slsc{A Tour of the Monuments of Passaic}}, New Jersey (1967). Publicado na revista {\slsc{Artforum}}}}}
%\end{minipage}
\end{figure}
...
hierárquica entre objeto e representação não existe mais.\footnote{A
  ...
  impossíveis'' Ver \scalebox{.8}{CARROLL}, Lewis. {\slsc{Alice's Adventures in
    Wonderland.}} Londres: Vintage Books, 2012, p. 11, trad. nossa.} Ele
...
cujo referente não existe mais.\footnote{Para Guilerme Wisnik, a
  ...
  eu me senti vivo. De fato, o penetrável Tropicália, com sua multidão
  de imagens tropicais, é uma espécie de condensação de lugares
  reais. Tropicália é um tipo de mapa. É um mapa do Rio, e é um mapa da
  ...
  único. Ver \scalebox{.8}{WISNIK}. {\slsc{Dentro do nevoeiro: diálogos cruzados
    entre arte e arquitetura contemporâneas}}. 2012. 1 v. Tese (Doutorado) --
  Fauusp, São Paulo, 2012.} Nesse mundo das aparências, uma ponte
...
\versal{XX}.\footnote{A obra de Long seria, para a escultura, o que o
  {\slsc{Quadrado negro}} (1915), de Malevich, é para a pintura: um
...
Por vezes associado à Land Art, o trabalho de Long se opõe à
...
seja, pode modificar a paisagem como um todo.\footnote{Jorge Luis Borges
  em \emph{Atlas} (1984), seu livro de viagens escrito com María Kodama,
  ...
  baja:\emph{~Estoy modificando el Sahara}'' (\versal{BORGES}, 2007c., p. 533).}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Richard Long. {\slsc{A line made by walking}} (1967)}}}
%\end{minipage}
\end{figure}

O arquiteto e professor italiano Francesco Careri (2013, p. 51), que
...
(\versal{ROTTENBERG}, 2014, trad. nossa), afirma categoricamente: ``eu preciso
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Richard Long. {\slsc{Fresh water salt water line walk}} (1980)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Francis Alÿs. {\slsc{The green line}} (2004)}}}
%\end{minipage}
\end{figure}

A relação entre a cartografia e arte da performance se dá, na maioria
...
com a polícia. O \emph{statement} inicial (\versal{HSIEH}, \versal{HEATHFIELD}, 2009, p.
160, trad. nossa), que serviu como protocolo a ser seguido, dizia:
...
observa-se que o artista raramente vai e voltar pela mesma rua,
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Tehching Hsieh. {\slsc{One Year Performance 1981--1982 (Outdoor Piece)}}}}}
%\end{minipage}
\end{figure}
...
com o famoso \emph{grid} de Nova York.\footnote{Criado a partir do
  \emph{Commissioners' Plan} de 1811.} Já Auster tira proveito do
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Andy Warhol. {\slsc{New York City Map}} (1949)}}}
%\end{minipage}
\end{figure}


\partepigraph{\emph{What is the city but the people?}}{William Shakespeare, \emph{Coriolanus} (1608)}
...
dois: o corte e a cola.\footnote{Não por coincidência, os dois gestos
  ...
  Manifesto da Arte Concreta, escrito por Theo van Doesburg em 1930,
...
``brimencidade'', ``tiplicidade''). Somem-se a isso as versões ao inglês
e ao francês sugeridas pelo poema, e as palavras se multiplicam anda
...
é a relação entre a cidade e o cidadão, muitas vezes determinada por
...
superfície (\versal{ROLNIK}, 2003. p. 76). Letreiros, placas, luminosos e peças
...
concreto.\footnote{O curta-metragem experimental \emph{Broadway by
  light} (1958), de William Klein, é uma sequência de tomadas noturnas
...
``campo magnético de possibilidades'' (\versal{CAMPOS}; \versal{PIGNATARI}; \versal{CAMPOS}, 1975,
p. 44).\footnote{Aqui vale lembrar de Haroldo de Campos (2004, p. 119) a
  respeito de suas \emph{galáxias}: ``trata-se de um livro para ser lido
...
``verbivocovisual'' da linguagem. (\versal{CAMPOS}; \versal{PIGNATARI}; \versal{CAMPOS}, 1975, p.
18).
...
\emph{Viagens de Marco Polo}, escritas no século \versal{XIII} por Rustichello da
...
O mérito do livro de Calvino advém dessa operação na fronteira entre
...
nesse cenário. Giulio Carlo Argan, nesse sentido, nos traz uma definição
fundamental: ``a forma de uma sociedade é a cidade e, ao construir a
cidade, a sociedade constrói a si mesma'' (1992, p.269).\footnote{Em
  \emph{Arte Moderna}, Argan associa essa visão à proposta pedagógica da
  Bauhaus (formulada por Walter Gropius) cujo objetivo seria a
  \emph{construção} de uma sociedade justa e democrática. Bauhaus
  significa, justamente, ``casa da construção''.}

A ideia de simultaneidade está presente na definição do arquiteto Paulo
Mendes da Rocha (\versal{WISNIK}, 2012a, p. 197), que enxerga o fenômeno urbano a
...
cidade, a \emph{polis}, o lugar político, a tribuna da vida moderna.
...
imperial por Robert Musil em \emph{O homem sem qualidades} (1930-43). A
...
ruídos.\footnote{Musil descreve Viena em 1913, às vésperas da Primeira
  ...
  hierarquia entre elas. No dodecafonismo, as sequencias musicais são
...
máquina em funcionamento.\footnote{O filme foi bastante influente a
  ponto de inspirar, já em 1929, uma versão brasileira: \emph{São Paulo,
  a sinfonia da metrópole}, dirigido pelos húngaros Rodolfo Lustig e
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Walter Ruttmann. {\slsc{Berlim, sinfonia de uma metrópole}} (1927)}}}
%\end{minipage}
\end{figure}
...
Para colocarmos nos termos de Michel de Certeau, há a cidade de Ícaro e
...
baixo.\footnote{Na mitologia grega, Ícaro era filho de Dédalo, o
  arquiteto do famoso labirinto do rei t Minos, em Creta. Em
  \emph{Metamorfoses}, o poeta latino Ovídio conta que os dois foram
...
quem a cidade é ``o mais desmesurado dos textos humanos'' (1998, p.
170). Certeau sobe ao 110º~andar do World Trade Center, em Nova York,
...
águas, pode agora ignorar as astúcias de Dédalo em labirintos móveis e
...
descreve Victor Hugo em \emph{Notre-Dame de Paris} (1831).\footnote{``Depois
  ...
  Ver Hugo, Victor. \emph{Notre-Dame de Paris.} Paris: Gallimard, 1966
...
jornal \emph{Folha de S. Paulo} em 1986.\footnote{Ver \versal{ANGELI}. Chiclete
  com banana: Bob Cuspe. \emph{Folha de S. Paulo}. São Paulo, p. 62.
  ...
  \emph{outsider}.} Nela, o punk paulistano Bob Cuspe contempla a cidade
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Angeli. {\slsc{Chiclete com banana: Bob Cuspe}}. Folha de S.~Paulo. 20 de junho de 1986}}}
%\end{minipage}
\end{figure}
...
antecipada pelo sociólogo alemão Georg Simmel no célebre ensaio \emph{A
...
seus limites imediatos. (\versal{SIMMEL}, 1973, p. 21).
...
Para David Harvey (2014, p. 69), o pós-modernismo implica um conceito
...
Na Berlim de Wenders podemos encontrar com toda sua beleza melancólica e
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Wim Wenders. {\slsc{Asas do Desejo}} (1987)}}}
%\end{minipage}
\end{figure}
...
cidades do mundo publicado por Georg Braun entre os séculos \versal{XVI} e \versal{XVII}
...
outros edifícios importantes.\footnote{Mesmo os desenhos de Charles
  ...
  cidade de São Paulo vista da várzea do Carmo no século \versal{XIX}, são
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{{\slsc{Civitates orbis terrarum}}. Mapa de Jerusalém}}}
%\end{minipage}
\end{figure}
...
forma unicamente territorial e passa adquirir camadas de subjetividades,
...
Otília Arantes (2001, p. 163), ao analisar os escritos de Jürgen
...
prática que caracteriza um mundo de vida.
...
``desintegração das figuras'' e dos ``referenciais visíveis'' (1993, p.
19). Nesse contexto de fragmentação, Virilio aponta para a urgência de
...
utópica de Lynch ao afirmar, por exemplo, que ``precisamos de um meio
ambiente que não seja simplesmente bem organizado, mas também poético e
simbólico'' (1980, p. 132). Diante da complexidade das metrópoles de
...
como percebe Paul Virilio:

A abolição das distâncias de tempo operada pelos diversos meios de
comunicação e telecomunicações resultou em uma confusão cujos efeitos
...
físicas (\versal{VIRILIO}, 1993, p. 22)
...
criatividade. Isso é que Jonathan Crary (2016, p. 60) chama de
...
Koolhaas enxerga nos aeroportos, shopping centers, parques de lazer,
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Tuca Vieira. {\slsc{São Paulo}} (2009)}}}
%\end{minipage}
\end{figure}

A cidade de São Paulo pode ser considerada essa cidade genérica por
excelência. Raquel Rolnik (2003. p. 75-76) refere-se à imposição de uma
...
essas perguntas imediatamente). Brissac vai ainda mais longe: ``a
...
proporção nem medida comum'' (1996, p. 398). Portanto, houve perda de
...
Deleuze e Guattari, Brissac propõe a substituição do binômio
...
``telépolis'', entre outros.\footnote{Ver \versal{RUFÍ}, Joan Vicente \versal{I}. Nuevas
  palabras, nuevas ciudades? \emph{Revista de Geografía,} Girona, n.
  2, p.79-103, 2003.} O mais comum é ``megalópole'', popularizado a
...
parte, não está em parte alguma.\footnote{A cidade assim descrita pode
  ...
  \emph{A esfera de Pascal} (1952).} Diferentemente da cidade
...
fracasso do urbanismo como organizador dessas grandes metrópoles, a
cidade é um grade sucesso. Num ensaio em que proclama a ``morte do
...
alarmante.\footnote{Ver United Nations, Department of Economic and
  Social Affairs, Population Division (2019).~\emph{World Population
...
(Tóquio e Osaka, no Japão).\footnote{Ver United Nations, Department of
  Economic and Social Affairs, Population Division (2018). \emph{World
...
estimativas.\footnote{Ver \versal{BURDETT}, Ricky; \versal{SUDJIC}, Deyan (Ed.).~The
  endless city.~Londres: Phaidon, 2007.} Neste cenário, uma dúvida que
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Tuca Vieira. {\slsc{Rio de Janeiro}} (2013)}}}
%\end{minipage}
\end{figure}

A cidade e a desigualdade social são duas chaves, indissociáveis entre
si, para entendermos o futuro da humanidade. As cidades não vão para de
...
mecanização do campo, a pesca predatória, o desmatamento e o exploração
...
Portanto, mesmo que a ruptura de escala a que nos referimos possa ser
...
Este cidadão \emph{prescinde} da cidade, mas paga um preço por isso. A
...
em verdadeiras fortalezas que apenas apartam a cidade real (\versal{ROLNIK},
2003, p. 77).
...
entre si e com o ambiente (\versal{ARGAN}, 1992, p. 265).
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Chargesheimer. {\slsc{Stalinalle}}, Berlim (1959)}}}
%\end{minipage}
\end{figure}
...
A surpresa deu lugar à constatação.\footnote{A palavra da língua inglesa
  \emph{spoiler} dá conta dessa sensação. O verbo \emph{to spoil}
  significa estragar, bagunçar, mas em seu significado popular o
  \emph{spoiler} é aquele que revela com antecedência algo de uma trama
  ou situação que deveria permanecer oculto para atingir seu efeito de
  surpresa, como o desfecho de um filme ou de um livro. O \emph{spoiler}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Ververidis Vasilis. Concerto em Tessalonica, Grécia (2014)}}}
%\end{minipage}
\end{figure}
...
comunicação, o número assinaturas de aparelhos celulares no mundo
igualou, em 2015, o número de habitantes do planeta.\footnote{Ver
  International Telecommunication Union. \emph{2015 facts and
  figures.} Genebra: \versal{ICT} data and statistics division, 2015.} São 7
...
que existe. (\versal{SANS}\ldots{}, 1983, trad. nossa).
...
compartilhadas.\footnote{Uma campanha da Kodak nos anos 1920 pode ser
  ...
  experiência do visitante. Ver \versal{AQUINO}, Lívia. \emph{Picture Ahead: a
...
curtíssimo'' (1992, p. 54).\footnote{O texto original é um artigo
  intitulado \emph{Le follie del mirino}, publicado na revista \emph{Il
  Contemporaneo} em 30 de abril de 1955. Foi adaptado depois pelo autor,
  integrando o livro \emph{Amores difícies} (1970) com o título \emph{A
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Raymond Depardon. {\slsc{Kodak Picture Spot}}, Los Angeles (1982)}}}
%\end{minipage}
\end{figure}
...
pode ser tornar um instrumento de deseducação do olhar,\footnote{Em
  ...
  alcance de qualquer imbecil''. Ver \versal{JAMMES}, André. \emph{Nadar}.
  Paris: Fondation Nationale de la~Photographie, 1982, p. 2. trad.
  nossa.} como percebe o mesmo Italo Calvino:
...
à estupidez, o segundo à loucura. (\versal{CALVINO}, 1992, p. 54)
...
O personagem de Rachael representava a antiga deia da substituição do
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Denis Villeneuve. {\slsc{Blade Runner 2049}} (2017)}}}
%\end{minipage}
\end{figure}
...
realidade e imagem, entre coisa e sua representação. Se hoje temos
...
Baudrillard dá mais salto, rompendo o último fio de conexão que ainda
vinculava o representação a seu referente. A relação do mapa com o
...
\addcontentsline{toc}{part}{Atlas fotográfico da cidade de São Paulo e seus arredores}

São Paulo é hoje a quinta maior cidade do planeta, com cerca de 21
milhões de habitantes.\footnote{Segundo o relatório da \versal{ONU} \emph{The
...
de 30 mil para mais de 2,5 milhões de habitantes (\versal{ROLNIK}, 2003, p.11).
...
multiplicou por 4.5 vezes. (\versal{SANTOS}, 1990, p. 17-18).
...
cidade tão complexa como esse. Parto do pressuporto de que a dificuldade
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Tuca Vieira. {\slsc{Paraisópolis}} (2004)}}}
%\end{minipage}
\end{figure}

Se Park e Musil já mostravam a complexidade da cidade ainda antes da
...
urbana.\footnote{Em 2018, estive em Pyongyang, capital da Coreia do
  ...
  \emph{tabula rasa} deixada pelos bombardeios norte-americano. A cidade
  ...
  condiciona sua interpretação. Em Pyongyang, vocês sempre sabe onde
  ...
  constroem essas cidades. Ver \versal{VIEIRA}, Tuca. Uma maquete de si
  mesma. \emph{Folha de S. Paulo.} São Paulo, p. C9. 21 abr. 2019.}
...
monumentalidade de Paris e da opulência de Nova York\footnote{Chamada de
  ``encantadora catástrofe'' por Le Corbusier. Ver \versal{LE
    CORBUSIER}. \emph{When the cathedrals were white}. Nova York:
...
assustaria, como podemos ver nessa definição de Raquel Rolnik:
...
acumulação material, da encenação do poder e da subordinação. (\versal{ROLNIK},
2003. p. 75-76).
...
naturalmente,l uma vez que a cidade que eu frequento diariamente a
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Google Earth. Fotografia de satélite da região metropolitana de São Paulo}}}
%\end{minipage}
\end{figure}
...
Eu já tinha bastante intimidade com o guia de ruas da cidade.\footnote{Refiro-me
  ...
  São Paulo em circulação na época: o \emph{Mapograf} (o mais completo),
  o \emph{Cartoplan} e o \emph{Quatro}-\emph{Rodas}.} Durante os
...
população que vive junto.\footnote{Urbanistas ingleses chamam essa área
  de \emph{brick and mortar zone} (zona de tijolo e argassa).}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Mapa-índice. {\slsc{Guia Quatro-Rodas Ruas de São Paulo}} (2011)}}}
%\end{minipage}
\end{figure}
...
no chamado ``grande formato'', utilizando chapas individuais de 4 x 5
...
resposta à pergunta: ``o que faria Militão nos dias de hoje?''\footnote{A
  fotografia de número 70 do \emph{Atlas}, realizada na Rua da Quitanda,
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Tuca Vieira. {\slsc{Atlas fotográfico da cidade de São Paulo e seus arredores}} (2015--2016)}}}
%\end{minipage}
\end{figure}
...
No mesmo sentido da afirmação de Argan, Georges Bataille (2006, p. 79)
...
expressão do ser dos indivíduos''.\footnote{Esta definição encontra-se
  ...
  \emph{Documents} (1929). Nesse artigo, ao mesmo tempo em que afirma o
...
\chapter*{Glossário}
\addcontentsline{toc}{part}{Glossário}
...
\begin{Parskip}
\versal{ADORNO}, Theodor. Anotações sobre Kafka. In: \_\_\_\_\_\_\_\_.
...
\_\_\_\_\_\_\_\_. \emph{História da arte como história da cidade.} São
Paulo: Martins Fontes, 1993.

\_\_\_\_\_\_\_\_. \emph{História da arte italiana: de Giotto a
Leonardo}. São Paulo: Cosac \& Naify, 2003. 3 v. (Vol. 2).

\_\_\_\_\_\_\_\_. \emph{História da arte Italiana: de Michelangelo ao
...
\versal{BARTHES}, Roland. Semiologia e urbanismo. In: \_\_\_\_\_\_\_\_. \emph{A
aventura semiológica.} São Paulo: Martins Fontes, 2001. p. 219-231.

\versal{BAUDELAIRE}, Charles. O pintor da vida moderna. In: \_\_\_\_\_\_\_\_.
\emph{Poesia e prosa.} Rio de Janeiro: Nova Aguiar, 1995. p. 851-881.

\versal{BAUDRILLARD}, Jean. \emph{O sistema dos objetos.} São Paulo:
Perspectiva, 2008.

\_\_\_\_\_\_\_\_. A precessão dos simulacros. In: \_\_\_\_\_\_\_\_.
\emph{Simulacros e simulação.} Lisboa: Relógio D'água, 1991. p. 7-58.

\versal{BAUDRILLARD}, Jean. \emph{A arte da desaparição.} Rio de Janeiro:
...
\_\_\_\_\_\_\_\_. \emph{Water towers.} Londres: The Mit Press, 1988.

\versal{BENJAMIN}, Walter. \emph{Obras escolhidas I: magia e técnica, arte e
política}. São Paulo: Brasiliense, 1985.

\versal{BERARDI}, Franco. \emph{Depois do futuro}. São Paulo: Ubu, 2019

\_\_\_\_\_\_\_\_. \emph{Obras escolhidas \versal{II}: rua de mão única}. São
Paulo: Brasiliense, 1987.

\versal{BORGES}, Jorge Luis. \emph{Obras completas \versal{I}: 1923-1949}. Buenos Aires:
Emecé, 2007.

\_\_\_\_\_\_\_\_. \emph{Obras completas \versal{II}: 1952-1972}. Buenos Aires:
Emecé, 2007.

\_\_\_\_\_\_\_\_. \emph{Obras completas \versal{III}: 1975-1985}. Buenos Aires:
Emecé, 2007.

\_\_\_\_\_\_\_\_. \emph{Obras completas \versal{IV}: 1975-1988}. Buenos Aires:
Emecé, 2007.

\_\_\_\_\_\_\_\_. \emph{Veiticinco agosto 1983 y otros cuentos.}
Madrí: Siruela, 1988.
...
\_\_\_\_\_\_\_\_. \emph{As cidades invisíveis.} São Paulo: Companhia
das Letras, 1990.

\_\_\_\_\_\_\_\_. O viajante no mapa. In: \_\_\_\_\_\_\_\_.
...
\_\_\_\_\_\_\_\_. \emph{The annotated Snark.} Nova York: W. W. Norton
\& Company, 1962. Martin Gardner (ed.).

Centre Georges Pompidou. \emph{Cartes et figures de la terre.}
{[}s.l.{]}, 1980.

\versal{CERTEAU}, Michel de. \emph{A escrita da história.} Rio de Janeiro: A
Escrita da História, 2002.

\_\_\_\_\_\_\_\_. \emph{A invenção do cotidiano: artes de fazer}.
...
COTTON, Charllotte. \emph{A fotografia como arte contemporânea}. São
...
\_\_\_\_\_\_\_\_. \emph{Mil platôs: capitalismo e esquizofrenia 2}.
...
\_\_\_\_\_\_\_\_. O artista como etnógrafo. In: \_\_\_\_\_\_\_\_.
\emph{O retorno do real.} São Paulo: Cosacnaify, 2014. p. 159-186.

\_\_\_\_\_\_\_\_. Postmodernism in parallax. \emph{October},
Cambridge, v. 63, p.3-20, 1993.

\versal{FOUCAULT}, Michel. \emph{O corpo utópico, as heterotopias.} São Paulo:
N-1, 2013.

\_\_\_\_\_\_\_\_. Des espaces autres. In: \_\_\_\_\_\_\_\_. \emph{Dits
et écrits: 1954-1988}, t. \versal{IV} (1980-1988). Paris: Gallimard, 1994. p.
752-762.
...
Atget: el viejo Paris}. Alcobendas: Tf Editores, 2011. p. 15-29.
...
composées. \emph{Le Monde.} Paris, p. 32-32. 23 maio 2001.

\versal{HALL}, Stuart. \emph{A identidade cultural na pós-modernidade.} Rio de
Janeiro: Dp\&a, 2006.

\versal{HAN}, Byung-chul. Sociedade do cansaço. Petrópolis: Vozes, 2015.
...
\_\_\_\_\_\_\_\_. \emph{Para entender \emph{O capital}: Livros \versal{II} e
\versal{III}}. São Paulo: Boitempo, 2014.

\_\_\_\_\_\_\_\_. \emph{Spaces of capital: towards a critical
geography}. New York: Routledge, 2001.

\versal{HEIDEGGER}, Martin. La cosa. In: \_\_\_\_\_\_\_\_. \emph{Conferencias y
artículos.} Bercelona: Ediciones del Serbal, 1994. p. 143-159.

\versal{HOBSBAWM}, Eric. \emph{Era dos extremos: o breve século \versal{XX}: 1914-1991}.
São Paulo: Companhia das Letras, 2003.

\versal{HOMERO}. \emph{Odisséia.} São Paulo: Cultrix, 2006. Tradução de Jaime
Bruna.
...
\_\_\_\_\_\_\_\_. \emph{Estética da ginga: a arquitetura da favela
...
\_\_\_\_\_\_\_\_. \emph{Espaço e imagem: Teorias do pós-moderno e
outros ensaios}. Rio de Janeiro: Editora \versal{UFRJ}, 2004.

\_\_\_\_\_\_\_\_. \emph{Pós-modernismo: a lógica cultural do
capitalismo tardio}. São Paulo: Ática, 2000.

\_\_\_\_\_\_\_\_. Cognitive Mapping. In: \versal{GROSSBERG}, Lawrence; \versal{NELSON},
Cary (Ed.). \emph{Marxism and the interpretation of culture.} Chicago:
University of Illinois Press, 1988. p. 347-360.

\_\_\_\_\_\_\_\_. Of islands and trenches: neutralization and the
production of utopian discourse. In: \_\_\_\_\_\_\_\_.
...
\_\_\_\_\_\_\_\_. \emph{Um artista da fome e a construção.} São Paulo:
Brasiliense, 1984.

\_\_\_\_\_\_\_\_. \emph{Um médico rural.} São Paulo: Companhia das
Letras, 2001.

\versal{KLEE}, Paul. \emph{Sobre a arte moderna e outros ensaios.} Rio de
Janeiro: Zahar, 2001.

KOOLHAAS, Rem. \emph{Delirious New York: a retroactive manifesto for
Manhattan}. Nova York: The Monacelli Press, 1994.

\_\_\_\_\_\_\_\_. \emph{Três textos sobre a cidade.} Barcelona:
Gustavo Gili, 2010.
...
\_\_\_\_\_\_\_\_. \emph{Espaço e política.} Belo Horizonte: Ufmg,
2008.

\_\_\_\_\_\_\_\_. \emph{La production de l'espace.} Paris: Anthropos,
1974.
...
\versal{PEIXOTO}, Nelson Brissac. \emph{Paisagens urbanas.} São Paulo: Senac,
1999.

\versal{PEREC}, Georges. \emph{Espèces d'espaces.} Paris: Galilée, 2000.

\_\_\_\_\_\_\_\_. \emph{Tentative d'épuisement d'un lieu parisien.}
...
\_\_\_\_\_\_\_\_. \emph{Territórios em conflito: São Paulo: espaço,
...
\_\_\_\_\_\_\_\_. \emph{Técnica, espaço, tempo: globalização e meio
...
\_\_\_\_\_\_\_\_. \emph{Writings/Interviews.} Chicago: The University
of Chicago Press, 1994.

\versal{SIMMEL}, Georg. A metrópole e a vida mental. In: \versal{VELHO}, Otávio Guilherme
(Org.). \emph{O fenômeno urbano.} Rio de Janeiro: Zahar, 1973. p.
11-25.
...
Berkeley: University of California Press, 1996. p. 58-75.
...
perspective. In: \_\_\_\_\_\_\_\_. \emph{The wretched of the screen.}
Berlin: Sternberg Press, 2012. p. 12-30.

\versal{STRUTH}, Thomas. \emph{Unconscious places.} Munique: Schirmer/mosel,
2012.
...
\_\_\_\_\_\_\_\_. \emph{O espaço crítico.} São Paulo: Editora 34,
1993.

\_\_\_\_\_\_\_\_. \emph{The administration of fear.} Los Angeles:
Semiotext(e), 2012.

\_\_\_\_\_\_\_\_. \emph{Velocidade e política.} São Paulo: Estação
Liberdade, 1996.

\versal{WALLACE}, David Foster. Alguns comentários sobre a graça de Kafka dos
quais provavelmente não se omitiu o bastante. In: \_\_\_\_\_\_\_\_.
\emph{Ficando longe do fato de já estar meio que longe de tudo}. São
Paulo: Companhia das Letras, 2012. p. 235-235.

\versal{WENDERS}, Wim. \emph{El acto de ver: textos y conversaciones}.
Barcelona: Paidós, 2005.

\_\_\_\_\_\_\_\_. \emph{Once: pictures and stories}. Nova York:
D.A.P., 2001.
...
Press, 1997. p. 295-300.

\versal{WISNIK}, Guilherme (Org.). \emph{Paulo Mendes da Rocha.} Rio de
Janeiro: Beco do Azougue, 2012.

\_\_\_\_\_\_\_\_. \emph{Dentro do nevoeiro: diálogos cruzados entre
arte e arquitetura contemporâneas}. 2012. 1 v. Tese (Doutorado) - Fauusp,
São Paulo, 2012.

\versal{WISNIK}, Guilherme.~\emph{Dentro do nevoeiro: arquitetura, arte e
tecnologia contemporâneas}. São Paulo: Ubu, 2018.

\_\_\_\_\_\_\_\_. \emph{Estado crítico:} à deriva nas cidades. São
...
Information and Geovisualization,} {[}s.l.{]}, v. 33, n. 4, p.1-12, dez.
...
Warburg And Courtauld Institutes,} Londres, v. 9, p. 96-121, 1946.

\versal{AUGÉ}, Marc. Assim a Internet tornou-se a nossa divindade.
\emph{Revista Iuh,} {[}s.l.{]}, n. 499, p.1-2, 19 dez. 2016.
...
\versal{BASTOS}, Antonio Virgílio Bittencourt. \emph{Mapas cognitivos e a
...
\versal{BATAILLE}, Georges. Georges Bataille: textos para a revista Documents.
\emph{Inimigo Rumor,} Rio de Janeiro, n. 19, p. 78-93, 2006.

\versal{BAUDELAIRE}, Charles. O público moderno e a fotografia. \emph{Revista
Facom}, São Paulo, v. 17, p.10-14, 2007.

\versal{BAUMAN}, Zygmunt. \emph{O fim do futuro.} 2014. Entrevista à revista
Época. Disponível em:
...
Journal of Experimental Biology,} Cambridge, n. 199, p.219-224, 1996.
Disponível em:
...
\emph{Sopro,} Desterro, n. 41, p.3-7, 01 dez. 2010. Disponível em:
...
\_\_\_\_\_\_\_\_. O que está acontecendo com as imagens?: arte, mídia e
educação em Jean Baudrillard. \emph{Filosofia e Educação}, {[}s.l.{]},
v. 8, n. 1, p.63-91, 23 fev. 2016. Universidade Estadual de Campinas.~

\versal{GIBSON}, William. William Gibson, the art of fiction No. 211. \emph{The
Paris Review,} New York, v. 197, p.1-1, 2011. Entrevista por David
...
{[}s.l.{]}, v. 26, n. 2, p.1-20, out. 1989. University of Toronto Press
Inc. (\versal{UTP}ress). http://dx.doi.org/10.3138/e635-7827-1757-9t53.
...
Perspectives,} {[}s.l.{]}, n. 53, p. 24-40, 1 mar. 2006. North American
...
\emph{Transcript}, Orkney, v. 2, n. 2, p. 38-51, 1 jan. 1997.
...
\emph{E-spania,} {[}s.l.{]}, n. 14, p.1-2, 13 set. 2012. OpenEdition.
...
\versal{LIMA}, Daniel. \emph{O céu nos observa.} Disponível em:
\textless{}http://oceunosobserva.blogspot.com.br/\textgreater{}. Acesso
em: 3 fev. 2017.

\versal{LONG}, Richard. \emph{Heaven and Earth.} 2009. Disponível em:
...
George Eastman House}, Rochester, v. 15, p. 1-4, jul. 1972.
...
\versal{NEGROPONTE}, Nicholas. Beyond Digital. \emph{Wired,} {[}s.l.{]}, n.
612, p.9998-9999, dez. 1998. Disponível em:
...
\emph{Terra Brasilis,} {[}s.l.{]}, n. 2, p.1-22, 21 jun. 2013.
...
Culture.} Chicago: University of Illinois Press, 1988. p. 381-403.

\versal{RANCIÈRE}, Jacques. A few remarks on the method of Jacques Rancière.
\emph{Parallax,} London, v. 15, n. 3, p.114-123, 2009. Disponível em:
...
\versal{RUFÍ}, Joan Vicente I. Nuevas palabras, nuevas ciudades? \emph{Revista
de Geografía,} Girona, n. 2, p. 79-103, 2003.

\versal{SAFATLE}, Vladimir. Do sublime capitalista e das ruínas.~\emph{Revista
Cult}, São Paulo, p.51-54, 2007.

\versal{SEABROOK}, John. E-Mail from Bill: Bill Gates's vision for the future.
\emph{The New Yorker}, Nova York, p. 48, 10 jan. 1994.

\versal{SOTH}, Alec. A conversation with Stephen Shore. \emph{Financial Times}.
...
Paulo, n. 57, p. 234-251, dez. 2013.

\versal{TILLMANS}, Wolfgang. Lecture.~\emph{Cine Qua Non}, Lisboa, p.16-47,
2012.

\versal{TOLMAN}, Edward. \emph{Cognitive maps in rats and men.} 1948. Publicado
...
\emph{Lugares/Representações.} São Paulo. 2011. p. 4-8.

\versal{ZIEGLER}, Ulf Erdmann (Ed.). O léxico industrial de Bernd e Hilla Becher.
\emph{Zum}, São Paulo, v. 01, p. 154-179, out. 2011.
\end{Parskip}
