...
Como se vê, há claramente uma transformação das estruturas fotografadas %Manter esse como se vê se as imagens forem ficar pretas?
...
seus próprios pontos de vista.\footnote{Como no conto {\slsc{A
  construção}}, de Kafka. Ver p.~\pageref{construcao}.} Para isso, faz uso
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Richard Serra. {\slsc{Spin out, for Robert Smithson}} (1973).\break Museu Kröller"-Müller, Holanda (foto: Tuca Vieira)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Folheto da obra {\slsc{Spin out, for Robert Smithson}} (1973).\break Museu Kröller"-Müller, Holanda}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Walter De Maria. {\slsc{Vertical earth kilometer}} (1977),\break Kassel, Alemanha (foto: Tuca Vieira)}}}
%\end{minipage}
\end{figure}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\tiny{\Formular{Robert Smithson. {\slsc{A tour of the monuments of Passaic}},\break New Jersey (1967). Publicado na revista {\slsc{Artforum}}}}}
%\end{minipage}
\end{figure}
...
cujo referente não existe mais.\footnote{Para Guilerme Wisnik, a
  ...
  único. Ver \scalebox{.8}{WISNIK}, Guilherme. {\slsc{Dentro do nevoeiro: diálogos cruzados
    entre arte e arquitetura contemporâneas}}. 2012. 1 v. Tese (Doutorado) --
  \scalebox{.8}{FAU-USP}, São Paulo, 2012.} Nesse mundo das aparências, uma ponte
...
\_\_\_\_\_\_\_\_. \emph{Imágenes pese a todo. Memoria Visual del Holocausto}. Barcelona: Paidós, 2004.
...
arte e arquitetura contemporâneas}. 2012. 1 v. Tese (Doutorado) - \scalebox{.8}{FAU-USP},
São Paulo, 2012.
